...
from storage_archiver import archive_snapshot, archive_bulletin, list_capsule_artifacts
import datetime

def test_archiving():
    """Test the archiving functions with sample data"""
    
    print("🗄️ Testing Codex Dominion Cloud Storage Archiving...")
    print("=" * 60)
    
    try:
        # Test snapshot archiving
        print("\n📊 Testing Snapshot Archiving...")
        ...
        print(f"✅ Snapshot archived successfully!")
        print(f"📍 URI: {snapshot_uri}")
        
        # Test bulletin archiving
        print("\n📝 Testing Bulletin Archiving...")
        
        current_time = datetime.datetime.utcnow().strftime('%Y-%m-%d %H:%M:%S')
        sample_bulletin = f"""# 🌅 Dawn Sovereignty Bulletin
...
| Active Capsules | 5 | 🟢 Full Deployment |
| Daily Executions | 2 | 🟢 Scheduled |
| Sovereignty Index | 0.85 | 🟢 High |

### 🔄 Recent Activities

- ✅ **Dawn Dispatch** completed successfully at 06:00 UTC
- ✅ **Signals Processing** running optimally  
- ✅ **Database Operations** performing within parameters
- ⏰ **Treasury Audit** scheduled for month-end
...
**🌟 Long live the Codex Dominion! 👑**
"""
        
        bulletin_uri = archive_bulletin(sample_bulletin, "dawn")
        print(f"✅ Bulletin archived successfully!")
        print(f"📍 URI: {bulletin_uri}")
        
        # Test artifact listing
        print(f"\n📋 Testing Artifact Listing...")
        
        artifacts = list_capsule_artifacts("signals-daily", limit=3)
        print(f"📊 Found {len(artifacts)} artifacts for 'signals-daily':")
        ...
        print(f"\n🎉 All archiving tests completed successfully!")
        print(f"💾 Cloud Storage Bucket: codex-artifacts-codex-dominion-prod")
        print(f"🔗 Versioning: Enabled")
        print(f"🗂️ Organization: Structured by type/capsule/date")
        
        return True
        
    except Exception as e:
        print(f"❌ Archiving test failed: {e}")
        return False
