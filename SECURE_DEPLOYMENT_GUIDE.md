...
1. **Secret Manager** → Returns encrypted password via IAM authentication
1. **Treasury connects** → Uses secret to authenticate with Cloud SQL
1. **All transactions** → Stored in encrypted PostgreSQL database
