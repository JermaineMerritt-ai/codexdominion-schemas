...
class TestWhatsAppBusiness(unittest.TestCase):
    ...
    def test_metrics_enhancement(self):
        ...
        self.assertAlmostEqual(enhanced["cost_per_conversation"], expected_cost_per_conversation, places=3)
    ...
    def test_business_performance_analysis(self):
        ...
        analysis = self.whatsapp_system._analyze_business_performance(current_metrics, [])
    ...
    def test_growth_metrics_calculation(self):
        ...
        for i in range(10):
            entry = {
                "ts": (datetime.datetime.now() - datetime.timedelta(days=i)).isoformat(),
        ...
        with patch.object(self.whatsapp_system, 'get_archive_history', return_value=history_data):
    ...
    def test_business_summary(self):
        ...
        expected_keys = [
            "conversations", "leads", "messaging_cost_usd",
            "lead_conversion_rate", "cost_per_conversation", 
            "business_performance_score", "cost_efficiency_rating"
        ]
