...
1. **Auto-Renewal:** Runs twice daily via systemd timer
1. **Monitoring:** Daily status checks and expiry notifications
1. **Renewal:** Automatic 30 days before expiry
1. **Post-Renewal:** Nginx automatically reloaded
