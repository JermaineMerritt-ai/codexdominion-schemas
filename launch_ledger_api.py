...
def start_ledger_api():
    ...
    try:
        ...
        try:
            ...
            # Run the server
            uvicorn.run("codex_ledger_api:app", host="127.0.0.1", port=8001, reload=True)
...
def test_endpoints():
    ...
    try:
        ...
        try:
            ...
            print("💡 Make sure the service is running with: python launch_ledger_api.py start")
            return
        except Exception as e:
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                if 'stats' in data:
                    stats = data['stats']
                    print(f"   📊 Total Revenue: ${stats['ledger']['total_revenue_usd']:,.2f}")
