...
class CodexEbookGenerator:
    ...
    def create_ebook_from_content(self, 
        ...
        project_file = self.output_dir / f"{self._sanitize_filename(title)}_project.json"
        project_data = {
    ...
    def create_ebook_from_markdown_files(self, 
        ...
        for i, md_file in enumerate(markdown_files):
            try:
                ...
                chapter_title = self._extract_title_from_markdown(content) or Path(md_file).stem
...
'''
    ...
    def _process_content_to_chapters(self, content: Union[str, Dict, List]) -> List[Dict]:
    ...
    def _generate_html_ebook(self, chapters: List[Dict], metadata: Dict, theme: str) -> Path:
        """Generate HTML ebook"""
    ...
    def _generate_epub_ebook(self, chapters: List[Dict], metadata: Dict, theme: str) -> Path:
    ...
    def _generate_pdf_ebook(self, chapters: List[Dict], metadata: Dict, theme: str) -> Path:
...
"""
    ...
    def _generate_epub_html_content(self, chapters: List[Dict], metadata: Dict, theme: str) -> str:
    ...
    def _generate_pdf_html_content(self, chapters: List[Dict], metadata: Dict, theme: str) -> str:
        """Generate PDF-optimized HTML content"""
        return self._generate_simple_html_content(chapters, metadata, theme, "pdf")
    
    def _generate_simple_html_content(self, chapters: List[Dict], metadata: Dict, theme: str, format_type: str) -> str:
