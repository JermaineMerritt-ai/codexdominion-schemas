...
def display_opening_ceremony():
    ...
    print(
        "   You now stand before the Codex Dominion — a living flame inscribed in ceremony,"
    )
    ...
    roles = [
        ...
        (
            "🌍 Participants",
            "Welcomed warmly, empowered to join",
            "WELCOME_AND_INDUCTION_PORTAL",
        ),
    ]
...
def launch_transmission_portal():
    ...
    try:
        ...
        result = subprocess.run(
            [sys.executable, "opening_transmission_portal.py"],
...
def main():
    ...
    try:
        ...
        launch_choice = (
            input("\n🔥 Launch the Interactive Gateway Portal now? (y/N): ")
            .strip()
            .lower()
        )
