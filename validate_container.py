...
def validate_container_setup():
    ...
    try:
        ...
        required_packages = ["fastapi", "uvicorn", "pandas", "numpy", "requests"]
    ...
    if passed_checks == total_checks:
        ...
        print(
            "1. Local test: .\\deploy_signals_container.ps1 -ProjectId test -LocalTest"
        )
        print(
            "2. Cloud deploy: .\\deploy_signals_container.ps1 -ProjectId YOUR_PROJECT_ID"
        )
        print(
            "3. Docker compose: docker-compose -f codex_signals/docker-compose.yml up"
        )
        return True
    else:
