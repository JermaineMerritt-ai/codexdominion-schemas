...
def archive_bulletin(bulletin_content: str, bulletin_type: str, 
                    capsule_slug: str = "sovereignty-bulletin") -> str:
    """
...
def archive_analysis_report(report_data: Dict[Any, Any], 
