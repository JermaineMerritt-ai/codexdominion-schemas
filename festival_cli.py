...
Examples:
  ...
  %(prog)s --list-recent 10
    ...
    parser.add_argument("--ceremony-type", default="sacred_cycle", help="Type of ceremony")
    
    # Special ceremonies
    parser.add_argument("--crown-flame", action="store_true", help="Perform flame crowning ceremony")
    parser.add_argument("--daily-dispatch", help="Record daily dispatch proclamation")
    parser.add_argument("--capsule-complete", nargs=2, metavar=("CAPSULE", "ARTIFACTS"), 
                       help="Record capsule completion (capsule_name artifact_count)")
    
    # Information commands
    parser.add_argument("--list-recent", type=int, metavar="N", help="List N most recent festival cycles")
    parser.add_argument("--show-status", action="store_true", help="Show festival system status")
    ...
    try:
        ...
        if args.crown_flame:
            ...
            cycle = keeper.proclaim_capsule_completion(capsule_name, int(artifact_count))
            ...
            if local_file.exists():
                try:
                    ...
                    print(f"📂 Local Status: {data.get('codex_festival_status', 'UNKNOWN')}")
                    ...
                    if data.get('cycles'):
                        ...
                        print(f"🎭 Latest Type: {latest.get('ceremony_type', 'unknown')}")
