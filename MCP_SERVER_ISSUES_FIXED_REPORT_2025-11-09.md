...
1. **list_directory** - Browse workspace directories safely
1. **system_status** - Get comprehensive system health information
1. **workspace_info** - Retrieve workspace configuration and structure
...
1. **Persistent Sessions:** WebSocket session management
1. **Advanced Analytics:** Request/response metrics
1. **Tool Extensions:** Additional MCP capabilities
...
1. **Authentication failures:** Verify API key in headers or query params
1. **Connection timeouts:** Check firewall and network connectivity
1. **File access errors:** Verify paths are within workspace boundaries
...
_Authority: MCP Infrastructure Team_
_Classification: ALL SYSTEMS OPERATIONAL_
