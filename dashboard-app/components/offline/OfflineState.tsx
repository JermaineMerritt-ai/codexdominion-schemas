    ...
    <div className={`flex flex-col items-center justify-center p-8 text-center ${className}`}>
      ...
      <div className="flex gap-3">
        {onRetry && (
          <button
            onClick={onRetry}
            className="px-4 py-2 bg-yellow-500 text-slate-900 rounded-lg hover:bg-yellow-400 transition-colors font-medium flex items-center gap-2"
          >
...
export function OfflineOverlay({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm">
      <div className="max-w-lg w-full mx-4 p-8 bg-slate-900 rounded-lg border border-slate-700 text-center">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="w-full px-4 py-2 bg-yellow-500 text-slate-900 rounded-lg hover:bg-yellow-400 transition-colors font-medium flex items-center justify-center gap-2"
          >
            <RefreshCw className="w-4 h-4" />
            Check Connection
          </button>
          ...
          {hasCachedData && onViewCached && (
            <button
              onClick={onViewCached}
              className="w-full px-4 py-2 bg-slate-700 text-white rounded-lg hover:bg-slate-600 transition-colors font-medium flex items-center justify-center gap-2"
            >
              <Database className="w-4 h-4" />
              View Cached Data
            </button>
...
export function ReconnectingIndicator({ attemptNumber = 1 }: ReconnectingProps) {
  return (
    <div className="flex items-center gap-3 px-4 py-3 bg-slate-900/90 border border-slate-700 rounded-lg">
