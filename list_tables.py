    ...
    try:
        with engine.connect() as connection:
            ...
            for row in tables:
                ...
                col_result = connection.execute(sqlalchemy.text(columns_query), (table_name,))
                ...
                for col in columns:
                    ...
                    print(f"     • {col_name:<20} {data_type:<15} {null_info:<8} {default_info}")
                ...
                idx_result = connection.execute(sqlalchemy.text(indexes_query), (table_name,))
            ...
            for row in tables:
                schema, table_name, owner = row
                count_result = connection.execute(sqlalchemy.text(f"SELECT COUNT(*) FROM {table_name}"))
