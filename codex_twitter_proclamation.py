...
class CodexTwitterProclaimer:
    ...
    def __init__(self, bearer_token: str = None, api_key: str = None, 
        ...
        self.bearer_token = bearer_token or config.get("bearer_token") or os.getenv("TWITTER_BEARER_TOKEN")
        self.api_key = api_key or config.get("api_key") or os.getenv("TWITTER_API_KEY")
        self.api_secret = api_secret or config.get("api_secret") or os.getenv("TWITTER_API_SECRET")
        self.access_token = access_token or config.get("access_token") or os.getenv("TWITTER_ACCESS_TOKEN")
        self.access_token_secret = access_token_secret or config.get("access_token_secret") or os.getenv("TWITTER_ACCESS_TOKEN_SECRET")
    ...
    def test_connection(self) -> bool:
        ...
        try:
            if self.client_v2:
                ...
                if user.data:
                    print(f"✅ Twitter connection successful! Account: @{user.data.username}")
                    return True
    ...
    def proclaim_scroll(self, text: str, scroll_type: str = "sovereignty", 
                       hashtags: List[str] = None, auto_hashtag: bool = True) -> Optional[Dict]:
        ...
        try:
            ...
            template = random.choice(self.proclamation_templates.get(scroll_type, self.proclamation_templates["sovereignty"]))
    ...
    def proclaim_thread(self, texts: List[str], thread_type: str = "sovereignty") -> List[Dict]:
    ...
    def proclaim_with_media(self, text: str, media_path: str, 
                          scroll_type: str = "sovereignty") -> Optional[Dict]:
    ...
    def schedule_proclamation(self, text: str, schedule_time: datetime, 
                            scroll_type: str = "sovereignty") -> Dict:
...
def proclaim_scroll(text: str, bearer_token: str = None):
    ...
    proclaimer = CodexTwitterProclaimer(bearer_token=bearer_token or "YOUR_TWITTER_BEARER")
