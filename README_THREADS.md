...
*Advanced Threads Analytics Engine*
...
*Setup and Configuration Assistant*
...
*Streamlit Interface in codex_simple_dashboard.py*
...
2. **Navigate to Threads Tab**: Click "🧵 Threads Engagement"
3. **Enter Profile ID**: Input your Threads Profile ID
4. **Get Analytics**: Click "📊 Get Engagement"
5. **View Results**: Comprehensive engagement dashboard
6. **Archive Data**: Click "💾 Archive Current"
...
2. **Create Instagram App**: Add "Instagram Basic Display" product
3. **Generate Access Token**: Long-lived access token required
4. **Configure Credentials**: Set environment variables or update config file
5. **Test Connection**: Use dashboard "🔄 Test Connection" button
