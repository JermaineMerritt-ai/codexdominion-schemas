...
def show_ultimate_overview():
    ...
    with col2:
        ...
        fig.update_layout(
            xaxis_title="Technology Readiness Level", yaxis_title="Market Impact Score"
        )
...
def show_ai_intelligence():
        ...
        if st.button("🧠 Generate AI Intelligence"):
            with st.spinner("Analyzing AI landscape..."):
                ...
                with col_b:
                    st.metric(
                        "Breakthrough Score",
                        f"{intelligence['breakthrough_score']:.1f}/10",
                    )
                with col_c:
                    st.metric(
                        "Commercial Readiness", intelligence["commercial_readiness"]
                    )
    ...
    with col2:
        ...
        fig.add_trace(
            go.Scatter(
                x=ai_evolution["Year"],
                y=ai_evolution["Model_Size_B"],
                mode="lines+markers",
                name="Model Size (Billions)",
        ...
        fig.update_layout(
            title="AI Model Size Evolution", yaxis_title="Parameters (Billions)"
        )
        fig2.update_layout(
            title="AI Capability Evolution", yaxis_title="Capability Score"
        )
...
def show_market_intelligence():
    ...
    with col1:
        ...
        fig = px.bar(
            market_data,
            x="Technology",
            y=["Market_Size_2025", "Projected_2030"],
