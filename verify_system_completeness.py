...
def main():
        ...
        if file_path.exists():
            ...
            if file.endswith('.json'):
                try:
                    ...
                    verification_results["critical_issues"].append(f"Invalid JSON: {file}")
        else:
    ...
    for dashboard in dashboard_files:
        ...
        if dashboard_path.exists():
            ...
            print(f"❌ {dashboard}")
            verification_results["critical_issues"].append(f"Missing dashboard: {dashboard}")
    
    # Calculate completion percentage
    completion_percentage = (verification_results["files_found"] / verification_results["files_checked"]) * 100
