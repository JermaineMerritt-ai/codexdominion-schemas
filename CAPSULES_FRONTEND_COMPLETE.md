...
2. **signals-daily-scheduler** (automated mode)
...
2. **View them in real-time** on the dashboard
3. **Track all executions** with full metadata
4. **Monitor operational sovereignty** across your entire system
