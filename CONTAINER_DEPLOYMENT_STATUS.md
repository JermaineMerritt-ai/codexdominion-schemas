...
2. **Cloud Storage Integration**: Direct artifact fetching from GCS
3. **Next.js Frontend Support**: API endpoints for CapsuleView components
4. **Production Scalability**: Auto-scaling FastAPI service
5. **Monitoring Ready**: Health check endpoints for Cloud Run
