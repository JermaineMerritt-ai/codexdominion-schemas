...
try:
    ...
    codex_integration_path = os.path.join(
...
class CodexEternumOmegaDashboard:
    ...
    def render_sovereign_header(self):
        ...
        with col1:
            ...
            st.caption(
                f"👑 Custodian: {self.omega.custodian} | Cycle: {self.omega.cycle} | Mode: {self.omega.mode}"
            )
    ...
    def render_capsule_series_status(self):
        ...
        for i, (_, capsule) in enumerate(df_capsules.iterrows()):
            with cols[i % 4]:
                ...
                st.metric(f"🧩 {capsule['Capsule']}", f"{icon} {capsule['Status']}")
    ...
    def render_sectoral_intelligence(self):
        ...
        with col1:
            ...
            for _, sector in df_sectors.iterrows():
                ...
                st.write(
                    f"{status_icon} **{sector['Sector']}**: {sector['Status']} ({sector['Function_Count']} functions)"
                )
    ...
    def render_sovereign_charter(self):
        ...
        with col2:
            ...
            st.metric(
                "🔗 Unification Status", f"✅ {charter_data['unification_status']}"
            )
    ...
    def render_custodian_recognition(self):
        ...
        with col1:
            with st.form("recognition_form"):
                ...
                action = st.text_area(
                    "Action/Achievement", value="Sovereign Dashboard Activation"
                )
