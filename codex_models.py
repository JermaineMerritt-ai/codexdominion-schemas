...
class CodexDataManager:
    ...
    def save_constellation(self, constellation: Constellation) -> bool:
        ...
        try:
            ...
            if not updated:
                constellations_data.setdefault('constellations', []).append(constellation_dict)
    ...
    def create_ledger_entry(self, source: Stream, cycle: str, amount: float) -> LedgerEntry:
    ...
    def create_constellation_from_revenue(self, name: str, revenue_data: Dict) -> Constellation:
