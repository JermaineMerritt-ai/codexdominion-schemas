...
1. **Service Starts** → `festival-scroll.service` launches
1. **Python Executes** → `/home/jermaine/festival_scroll.py` runs
1. **Ceremonies Complete** → Festival renewal processes finish
1. **Service Stops** → Waits for next dawn trigger
