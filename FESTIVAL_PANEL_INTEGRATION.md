...
1. **`frontend/pages/api/festival.ts`** - API endpoint to fetch festival data
1. **`frontend/pages/festival.tsx`** - Complete Festival Dashboard page
1. **Updated `frontend/pages/index.js`** - Added Festival link to main navigation
...
1. **Visit Festival Dashboard**: `http://localhost:3000/festival`
1. **Create New Ceremonies**: Use the Python CLI or API
1. **Watch Auto-Recording**: Run capsules to see automatic ceremony creation
