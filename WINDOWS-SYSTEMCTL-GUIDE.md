...
1. **codex-systemctl.ps1** - PowerShell service manager
1. **codex-dashboard-service.ps1** - Individual service control
1. **configure-firewall.ps1** - Windows firewall setup (run as Admin)
1. **configure-firewall.bat** - Batch version of firewall setup
