...
'''
    ...
    dashboard_path = base_path / "codex-suite" / "apps" / "dashboard" / "codex_unified.py"
    ...
    print("✅ Run: streamlit run codex-suite/apps/dashboard/codex_unified.py --server.port 8050")
