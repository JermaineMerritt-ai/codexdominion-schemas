...
def generate_drafts(prompt):
    ...
    return [
        {"title": "Draft A", "text": "Sovereign opening. Clear value. One decisive CTA."},
        {"title": "Draft B", "text": "Warm narrative. Ritual cadence. Invitation to witness."},
        {"title": "Draft C", "text": "Direct signal. Measurable outcome. Minimal flourish."},
    ]
