...
from .settings import BRAND_FILE, get_data_path
    ...
    def consolidate_memories(self, days_old: int = 30) -> Dict[str, int]:
        ...
        for memory_id, memory in list(data["memories"].items()):
            ...
            if (
                ...
                and memory.get("importance", 0) < 3
                and memory.get("access_count", 0) < 2
            ):
            ...
            elif created_date < cutoff_date and memory.get("access_count", 0) > 10:
