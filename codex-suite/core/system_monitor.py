...
class SystemMonitor:
    ...
    def check_memory(self):
        ...
        return {
            ...
            "status": (
                ...
                else "GOOD" if memory.percent < 85 else "CRITICAL"
            ),
        }
    ...
    def check_disk(self):
        ...
        return {
            ...
            "status": (
                ...
                else "GOOD" if disk.used / disk.total < 0.9 else "CRITICAL"
            ),
        }
    ...
    def check_cpu(self):
        ...
        return {
            ...
            "status": (
                "EXCELLENT"
                if cpu_percent < 50
                else "GOOD" if cpu_percent < 80 else "HIGH"
            ),
        }
    ...
    def check_wsl_status(self):
        ...
        try:
            ...
            return {"status": "ERROR", "error": str(e), "docker_proxy_error": True}
