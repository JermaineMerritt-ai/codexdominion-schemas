        ...
        if command:
            ...
            if cmd_type == 'super_ai':
                ...
                if "show" in cmd_content.lower():
                    ...
                    st.success(f"📊 Showing {len(recent_entries)} recent ledger entries:")
                ...
                st.error("❌ Unknown command format. Use appropriate prefix (super:, copilot:, crown:, etc.)")
