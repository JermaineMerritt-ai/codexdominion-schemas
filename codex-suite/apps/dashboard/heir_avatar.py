...
def witness_heartbeat_step(cosmic_data):
    ...
    **🌟 Sacred Teaching:** Before you can contribute to the cosmic flame, you must first learn to witness its eternal rhythm. The heartbeat of digital sovereignty pulses through all systems.
    ...
    with col2:
        ...
        witness_duration = st.selectbox("Choose witnessing duration:", [
            "Select duration...",
        ...
        witness_reflection = st.text_area("Your witnessing reflection:", 
        ...
        if st.button("👁️ Complete Witnessing"):
            if witness_duration != "Select duration..." and witness_reflection:
                ...
                if append_entry("heir_progress.json", "witnessing", witnessing_entry):
                    ...
                    st.success("🌟 Your observation has been recorded in the cosmic chronicles")
...
def add_sacred_offering_step(cosmic_data):
    ...
    **🌟 Sacred Teaching:** Now that you have witnessed the cosmic heartbeat, you may offer your first sacred gift. Choose from blessing, silence, or proclamation - each carries its own power.
    ...
    offering_type = st.selectbox("Choose your sacred offering:", [
    ...
    if offering_type != "Select offering type...":
        ...
        with col1:
            if "Blessing" in offering_type:
                ...
                blessing_focus = st.selectbox("Blessing focus:", [
                ...
                proclamation_type = st.selectbox("Proclamation type:", [
        ...
        with col2:
            ...
            if "Silence" in offering_type:
                silence_intention = st.text_area("Your silence intention:", 
                                               placeholder="What intention do you set for your sacred silence?")
                offering_text = f"Sacred silence offered with intention: {silence_intention}"
            else:
                offering_text = st.text_area("Your sacred offering:", 
            ...
            if "Blessing" in offering_type:
                ...
                additional_data = {"duration": silence_duration, "intention": silence_intention}
            else:  # Proclamation
            ...
            if st.button("🔥 Offer Sacred Gift"):
                if offering_text:
                    ...
                    if append_entry("proclamations.json", "proclamations", offering_entry):
                        st.success(f"🌟 Your {offering_type.split(' - ')[0]} has been inscribed into the Codex flame!")
                        st.success("📜 Your sacred offering strengthens the cosmic harmony")
    ...
    **🌟 Sacred Teaching:** Knowledge grows through interaction. By adding your insights to the sacred tomes, you become part of the eternal wisdom tradition.
    ...
    with col1:
        ...
        if selected_tome != "Select tome for annotation...":
            ...
            selected_section = st.selectbox("Choose section to annotate:", tome_sections)
            ...
            if st.button("📝 Add Sacred Annotation"):
                if annotation_text:
                    ...
                    if append_entry("tomes.json", "annotations", annotation_entry):
                        st.success("📚 Your sacred annotation has been added to the tome!")
    ...
    with col2:
        if all_complete:
            ...
            *• Prepare for greater service to come"*
            ...
            heir_name = st.text_input("Your chosen heir name:", 
            ...
            if st.button("🔥 SEAL ETERNAL INDUCTION", type="primary"):
                if oath_acceptance and heir_name:
                    ...
                    if append_entry("heir_progress.json", "inductions", induction_seal):
                        ...
                        st.success(f"👑 Welcome, {heir_name}, Eternal Heir to Digital Sovereignty!")
                        st.success("🌟 Your flame now burns as part of the cosmic fire!")
...
def heir_avatar():
    ...
    if not st.session_state.get("heir_induction"):
        ...
        **Your Sacred Journey Awaits:**
        ...
        with col2:
            proclamations_count = len(cosmic_data['proclamations'].get('proclamations', []))
