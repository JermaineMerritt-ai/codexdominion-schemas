...
class AdvancedCodexEbookGenerator:
    ...
    def create_comprehensive_ebook(
        self,
        title: str,
    ...
    def _organize_content_into_chapters(self, content: Dict[str, Any]) -> List[Dict]:
        ...
        if "proclamations" in content:
            proc_chapters = self._process_proclamations_to_chapters(
        ...
        if "documentation" in content:
            doc_chapters = self._process_documentation_to_chapters(
    ...
    def _process_proclamations_to_chapters(
    ...
    def _generate_advanced_html(self, chapters: List[Dict], metadata: Dict) -> Path:
        ...
        theme = self.themes.get(
            metadata.get("theme", "dominion"), self.themes["dominion"]
        )
    ...
    def _build_advanced_html_content(
        self, chapters: List[Dict], metadata: Dict, theme: Dict
    ) -> str:
...
"""
    ...
    def _save_project_file(
        self, metadata: Dict, chapters: List[Dict], output_files: Dict
    ) -> Path:
