...
var StorefrontBlessing = function (_a) {
    var _b = _a.storeName, storeName = _b === void 0 ? 'aistorelab.com' : _b, _c = _a.storeUrl, storeUrl = _c === void 0 ? 'https://aistorelab.com' : _c, _d = _a.variant, variant = _d === void 0 ? 'full' : _d, _e = _a.showCouncilSeal, showCouncilSeal = _e === void 0 ? true : _e;
    if (variant === 'banner') {
        return (<div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 rounded-lg p-4 border border-yellow-500/30 text-center">
        ...
        <p className="text-gray-300 text-sm">
          ...
          <link_1.default href={storeUrl} target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300 mx-1 underline">
            {storeName}
          </link_1.default>
        </p>
      </div>);
    ...
    if (variant === 'compact') {
        return (<div className="bg-gradient-to-r from-yellow-600/15 to-orange-600/15 rounded-lg p-6 border border-yellow-500/20">
        ...
        <div className="text-center space-y-3 text-gray-200">
          <p className="italic">
            ...
            <link_1.default href={storeUrl} target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300 underline font-medium">
              {storeName}
            </link_1.default>
          </p>
    ...
    return (<div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 rounded-xl p-8 border-2 border-yellow-500/30 relative overflow-hidden">
...
exports.default = StorefrontBlessing;
