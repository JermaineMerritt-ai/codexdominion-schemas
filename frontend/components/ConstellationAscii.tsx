...
const ConstellationAscii: React.FC<ConstellationAsciiProps> = ({
  ...
  return (
    <div className={`font-mono ${sizeClasses[size]} text-center relative overflow-x-auto`}>
      ...
      <div className="mb-4">
        <div
          className={`${currentTheme.central} font-bold ${showAnimation ? 'animate-pulse' : ''}`}
        >
          ✨ Codexdominion.app ✨
        </div>
...
/                                    |                                    \\`}
      ...
      <div className="grid md:grid-cols-3 gap-4 text-xs">
        ...
        <div className="space-y-2">
          <div className={`${currentTheme.domains.storefront} font-bold`}>🛍️ aistorelab.com</div>
          <div className={`${currentTheme.domains.storefront} opacity-75`}>(Storefront Crown)</div>
        ...
        {/* Center Column */}
        <div className="space-y-2">
          <div className={`${currentTheme.domains.personal} font-bold`}>✍️ jermaineai.com</div>
          <div className={`${currentTheme.domains.personal} opacity-75`}>(Personal Crown)</div>
          <div className={`${currentTheme.domains.council} font-bold mt-3`}>
            🏛️ jermaineai.online
          </div>
          <div className={`${currentTheme.domains.council} opacity-75`}>(Council Crown)</div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className={`${currentTheme.domains.premium} opacity-75`}>(Premium Crown)</div>
        </div>
      </div>
