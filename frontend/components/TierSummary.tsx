...
export const TierSummary: React.FC<TierSummaryProps> = ({ tierCounts, generatedAt, banner }) => {
          ...
          >
            <div
              className={`${styles.tierCount} ${
                tier.name === 'Alpha'
                  ? styles.tierCountAlpha
                  : tier.name === 'Beta'
                    ? styles.tierCountBeta
                    : tier.name === 'Gamma'
                      ? styles.tierCountGamma
                      : tier.name === 'Delta'
                        ? styles.tierCountDelta
                        : ''
              }`}
            >
              {tier.count}
