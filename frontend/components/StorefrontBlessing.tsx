    ...
    return (
      <div className="bg-gradient-to-r from-yellow-600/20 to-orange-600/20 rounded-lg p-4 border border-yellow-500/30 text-center">
        ...
        <p className="text-gray-300 text-sm">
          ...
          <Link href={storeUrl} target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300 mx-1 underline">
            {storeName}
          </Link>
        </p>
      </div>
      ...
      <div className="bg-gradient-to-r from-yellow-600/15 to-orange-600/15 rounded-lg p-6 border border-yellow-500/20">
        ...
        <div className="text-center space-y-3 text-gray-200">
          <p className="italic">
            ...
            <Link href={storeUrl} target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300 underline font-medium">
              {storeName}
            </Link>
          </p>
