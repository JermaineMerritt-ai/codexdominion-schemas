      ...
      {governanceElements.map((element, index) => (
        ...
        >
          <div
            ...
            style={{
              filter:
                governancePhase === index ? 'drop-shadow(0 0 40px rgba(255, 215, 0, 1))' : 'none',
            }}
          >
            {element.icon}
          </div>
        ...
        >
          <div
            ...
            style={{
              filter:
                echoPhase === i
                  ? `drop-shadow(0 0 35px rgba(255, 255, 255, ${echoIntensity}))`
                  : 'none',
            }}
          >
            🌌
          ...
          <div
            className={`text-xl font-semibold ${echoPhase === i ? 'text-white' : 'text-gray-400'}`}
          >
            Echo {i + 1}
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gold-900 via-amber-800 to-black relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-20">
        <div
          className="absolute top-1/10 left-1/10 w-64 h-64 bg-gold-400/30 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '22s' }}
        />
        <div
          className="absolute bottom-1/10 right-1/10 w-72 h-72 bg-amber-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '28s', animationDelay: '4s' }}
        />
        <div
          className="absolute top-1/2 right-1/6 w-88 h-88 bg-orange-400/20 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '35s', animationDelay: '8s' }}
        />
        <div
          className="absolute bottom-1/4 left-1/6 w-80 h-80 bg-yellow-400/15 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '42s', animationDelay: '12s' }}
        />
        <div
          className="absolute top-2/3 left-1/12 w-56 h-56 bg-red-400/22 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '50s', animationDelay: '16s' }}
        />
        <div
          className="absolute bottom-1/2 right-1/12 w-68 h-68 bg-white/10 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '58s', animationDelay: '20s' }}
        />
        <div
          className="absolute top-1/4 left-1/3 w-76 h-76 bg-purple-400/12 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '65s', animationDelay: '24s' }}
        />
        <div
          className="absolute bottom-3/4 right-1/3 w-60 h-60 bg-cyan-400/18 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '72s', animationDelay: '28s' }}
        />
      </div>
    </div>
  );
