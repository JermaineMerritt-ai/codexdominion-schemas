        ...
        <div className="flex justify-center items-center space-x-12 mb-6">
          ...
          <div className="text-center">
            <div
              ...
              style={{
                filter:
                  dailyPhase % 6 === 0 ? 'drop-shadow(0 0 70px rgba(255, 140, 0, 1.5))' : 'none',
              }}
            >
              ☀️
            </div>
          ...
          <div className="text-center">
            <div
              ...
              style={{
                filter:
                  cosmicPhase % 3 === 0 ? 'drop-shadow(0 0 90px rgba(138, 43, 226, 1.5))' : 'none',
              }}
            >
              🌌
            </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gold-400 via-white to-purple-600 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-12">
        <div
          className="absolute top-1/20 left-1/20 w-32 h-32 bg-gold-300/30 rounded-full filter blur-2xl animate-pulse"
          style={{ animationDuration: '20s' }}
        />
        <div
          className="absolute bottom-1/20 right-1/20 w-40 h-40 bg-white/25 rounded-full filter blur-2xl animate-pulse"
          style={{ animationDuration: '28s', animationDelay: '2s' }}
        />
        <div
          className="absolute top-1/2 right-1/12 w-48 h-48 bg-purple-300/20 rounded-full filter blur-2xl animate-pulse"
          style={{ animationDuration: '35s', animationDelay: '4s' }}
        />
        <div
          className="absolute bottom-1/6 left-1/12 w-44 h-44 bg-amber-300/18 rounded-full filter blur-2xl animate-pulse"
          style={{ animationDuration: '42s', animationDelay: '6s' }}
        />
        <div
          className="absolute top-2/3 left-1/20 w-36 h-36 bg-cyan-300/22 rounded-full filter blur-2xl animate-pulse"
          style={{ animationDuration: '50s', animationDelay: '8s' }}
        />
      </div>
    </div>
  );
