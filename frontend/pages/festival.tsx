          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
            ...
            <div className="text-lg font-semibold capitalize">
              {ceremonyData?.metadata?.flame_status?.replace(/_/g, ' ') ||
                festivalData?.metadata?.flame_status?.replace(/_/g, ' ') ||
                'Dormant'}
            </div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-4">
              ...
              <div className="flex flex-wrap items-center gap-4">
                <div>
                  ...
                  <select
                    ...
                    aria-label="Select ceremony type"
                    title="Select ceremony type"
                  >
                ...
                <div>
                  ...
                  <select
                    ...
                    className="border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                    aria-label="Select number of recent ceremonies to show"
                    title="Select number of recent ceremonies to show"
                  >
                ...
                <div className="ml-auto">
                  <button
                    ...
                    aria-label="Refresh festival data"
                    title="Refresh festival data"
                  >
                    Refresh
                  </button>
                </div>
