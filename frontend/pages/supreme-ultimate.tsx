  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gold-600 via-white to-purple-700 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-25">
        <div
          className="absolute top-1/32 left-1/32 w-48 h-48 bg-gold-400/55 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '42s' }}
        />
        <div
          className="absolute bottom-1/32 right-1/32 w-56 h-56 bg-white/50 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '50s', animationDelay: '3s' }}
        />
        <div
          className="absolute top-1/2 right-1/24 w-64 h-64 bg-purple-400/45 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '60s', animationDelay: '6s' }}
        />
        <div
          className="absolute bottom-1/12 left-1/24 w-60 h-60 bg-yellow-400/40 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '68s', animationDelay: '9s' }}
        />
        <div
          className="absolute top-2/3 left-1/32 w-44 h-44 bg-green-400/48 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '76s', animationDelay: '12s' }}
        />
        <div
          className="absolute bottom-1/2 right-1/32 w-52 h-52 bg-cyan-400/43 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '85s', animationDelay: '15s' }}
        />
        <div
          className="absolute top-1/4 left-1/12 w-68 h-68 bg-red-400/38 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '93s', animationDelay: '18s' }}
        />
        <div
          className="absolute bottom-3/4 right-1/12 w-40 h-40 bg-blue-400/45 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '102s', animationDelay: '21s' }}
        />
        <div
          className="absolute top-1/12 left-1/6 w-36 h-36 bg-indigo-400/50 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '110s', animationDelay: '24s' }}
        />
        <div
          className="absolute bottom-1/24 right-1/6 w-32 h-32 bg-violet-400/55 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '120s', animationDelay: '27s' }}
        />
      </div>
    </div>
  );
