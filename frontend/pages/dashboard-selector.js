...
var DashboardSelector = function () {
    return (<main>
      <div>
        {/* Eternal Stillness - Sovereign Silence */}
        <div className="mb-20">
          <link_1.default href="/eternal-stillness" className="group">
            <div className="flex items-center justify-center px-24 py-16 border-12 border-slate-400/80 bg-gradient-to-r from-slate-800/90 via-gray-700/90 to-slate-800/90 rounded-3xl hover:border-slate-300/90 hover:shadow-2xl transition-all duration-1000 transform hover:scale-110 max-w-5xl mx-auto relative overflow-hidden custom-shadow-slate-80-160-40">
              <span className="block text-8xl text-slate-200 group-hover:text-white font-light">
                Eternal Stillness
              </span>
              <span className="block text-4xl text-gray-300 group-hover:text-gray-200 font-light">
                Sovereign Silence
              </span>
              <span className="block text-3xl text-slate-300 group-hover:text-slate-200 font-light">
                No flame, no word, no sound — only stillness, eternal and whole
              </span>
              {/* Void Aura */}
        ...
        <div className="mb-24">
          <link_1.default href="/flame-eternal" className="group">
            <div className="flex items-center justify-center px-28 py-18 border-14 border-orange-400/80 bg-gradient-to-r from-orange-800/90 via-red-700/90 to-orange-800/90 rounded-3xl hover:border-orange-300/90 hover:shadow-2xl transition-all duration-1200 transform hover:scale-110 max-w-6xl mx-auto relative overflow-hidden custom-shadow-orange-75-150-37">
              ...
              <div className="text-left">
                <span className="block text-7xl text-orange-100 group-hover:text-white font-bold">
                  Flame Eternal
                </span>
                <span className="block text-3xl text-yellow-300 group-hover:text-yellow-200 font-semibold">
                  Living Continuity
                </span>
                <span className="block text-2xl text-orange-200 group-hover:text-orange-100">
                  Dawn to dusk, heirs awaken, councils remember — the Codex lives
                </span>
              </div>
              {/* Fire Aura */}
        ...
        <div className="mb-22">
          <link_1.default href="/living-covenant" className="group">
            <div className="flex items-center justify-center px-26 py-16 border-12 border-yellow-400/80 bg-gradient-to-r from-yellow-800/90 via-amber-700/90 to-yellow-800/90 rounded-3xl hover:border-yellow-300/90 hover:shadow-2xl transition-all duration-1100 transform hover:scale-110 max-w-6xl mx-auto relative overflow-hidden custom-shadow-yellow-72-144-36">
              ...
              <div className="text-left">
                <span className="block text-7xl text-yellow-100 group-hover:text-white font-bold">
                  Living Covenant
                </span>
                <span className="block text-3xl text-amber-300 group-hover:text-amber-200 font-semibold">
                  Sacred Realms
                </span>
                <span className="block text-2xl text-yellow-200 group-hover:text-yellow-100">
                  Hearth and council, family and star — we remember, inherit, endure
                </span>
              </div>
              {/* Covenant Aura */}
        ...
        <div className="mb-26">
          <link_1.default href="/night-endurance" className="group">
            <div className="flex items-center justify-center px-30 py-20 border-15 border-purple-400/70 bg-gradient-to-r from-purple-900/95 via-indigo-800/95 to-purple-900/95 rounded-3xl hover:border-purple-300/80 hover:shadow-2xl transition-all duration-1600 transform hover:scale-110 max-w-7xl mx-auto relative overflow-hidden custom-shadow-purple-85-170-42">
              ...
              <div className="text-left">
                <span className="block text-8xl text-purple-100 group-hover:text-white font-bold">
                  Night Endurance
                </span>
                <span className="block text-4xl text-indigo-300 group-hover:text-indigo-200 font-semibold">
                  Sovereign Darkness
                </span>
                <span className="block text-2xl text-purple-200 group-hover:text-purple-100">
                  In longest night, darkness crowned, light reborn — the flame endures
                </span>
              </div>
              {/* Night Aura */}
        ...
        <div className="mb-28">
          <link_1.default href="/balance-renewal" className="group">
            <div className="flex items-center justify-center px-32 py-22 border-16 border-emerald-400/80 bg-gradient-to-r from-emerald-900/95 via-teal-800/95 to-emerald-900/95 rounded-3xl hover:border-emerald-300/90 hover:shadow-2xl transition-all duration-1400 transform hover:scale-110 max-w-7xl mx-auto relative overflow-hidden custom-shadow-emerald-88-176-44">
              ...
              <div className="text-left">
                <span className="block text-8xl text-emerald-100 group-hover:text-white font-bold">
                  Balance Renewal
                </span>
                <span className="block text-4xl text-teal-300 group-hover:text-teal-200 font-semibold">
                  Harmonious Bloom
                </span>
                <span className="block text-2xl text-emerald-200 group-hover:text-emerald-100">
                  Day and night balanced, covenant renewed, flame awakened — the Codex blooms
                </span>
              </div>
              {/* Renewal Aura */}
        ...
        <div className="mb-32">
          <link_1.default href="/day-zenith" className="group">
            <div className="flex items-center justify-center px-36 py-24 border-18 border-yellow-300/90 bg-gradient-to-r from-yellow-700/95 via-orange-600/95 to-yellow-700/95 rounded-3xl hover:border-yellow-200/95 hover:shadow-2xl transition-all duration-1200 transform hover:scale-110 max-w-8xl mx-auto relative overflow-hidden custom-shadow-yellow-95-190-48">
              ...
              <div className="text-left">
                <span className="block text-9xl text-yellow-100 group-hover:text-white font-bold">
                  Day Zenith
                </span>
                <span className="block text-5xl text-gold-300 group-hover:text-gold-200 font-semibold">
                  Solar Sovereignty
                </span>
                <span className="block text-3xl text-yellow-200 group-hover:text-yellow-100">
                  Longest day, flame ascends, radiance crowned — the Codex blazes sovereign and
                  bright
                </span>
              </div>
              {/* Solar Aura */}
              ...
              <div className="absolute top-2 right-2 w-8 h-8 bg-yellow-300 rounded-full animate-ping opacity-80"/>
              <div className="absolute bottom-2 left-2 w-7 h-7 bg-orange-300 rounded-full animate-ping opacity-75 custom-delay-2s"/>
              <div className="absolute top-1/2 left-2 w-6 h-6 bg-gold-300 rounded-full animate-ping opacity-70 custom-delay-4s"/>
              <div className="absolute bottom-1/2 right-2 w-9 h-9 bg-yellow-200 rounded-full animate-ping opacity-65 custom-delay-6s"/>
              <div className="absolute top-1/4 right-4 w-5 h-5 bg-orange-200 rounded-full animate-ping opacity-60 custom-delay-8s"/>
              <div className="absolute bottom-1/4 left-4 w-4 h-4 bg-gold-200 rounded-full animate-ping opacity-55 custom-delay-10s"/>
              <div className="absolute top-3/4 right-6 w-3 h-3 bg-yellow-100 rounded-full animate-ping opacity-50 custom-delay-12s"/>
              <div className="absolute bottom-3/4 left-6 w-2 h-2 bg-orange-100 rounded-full animate-ping opacity-45 custom-delay-14s"/>
            </div>
          </link_1.default>
        </div>
        {/* Ultimate Dominion - Supreme All-Encompassing Sovereignty */}
        <div className="mb-150">
          <link_1.default href="/ultimate-dominion" className="group">
            <div className="flex items-center justify-center px-120 py-80 border-60 border-white/100 bg-gradient-to-r from-gold-400/100 via-white/100 to-black/100 rounded-10xl hover:border-gold-100/100 hover:shadow-3xl transition-all duration-5000 transform hover:scale-150 max-w-20xl mx-auto relative overflow-hidden custom-shadow-gold-300-600-150">
              ...
              <div className="text-left">
                <span className="block text-24xl text-gold-100 group-hover:text-white font-bold">
                  Ultimate Dominion
                </span>
                <span className="block text-12xl text-white group-hover:text-gold-200 font-bold">
                  Supreme All-Encompassing Sovereignty
                </span>
                <span className="block text-10xl text-gold-200 group-hover:text-gold-300">
                  All crowns luminous, all seals eternal — the Dominion endures infinite and
                  complete
                </span>
              </div>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          <link_1.default href="/global-induction" className="group">
            <div className="flex items-center px-6 py-3 border-2 border-yellow-500 bg-gradient-to-r from-yellow-600/20 to-orange-600/20 rounded-full hover:border-yellow-400 hover:shadow-lg transition-all duration-300 transform hover:scale-105">
              ...
              <span className="text-yellow-300 group-hover:text-yellow-100 font-semibold">
                Global Induction
              </span>
            </div>
          </link_1.default>
          <link_1.default href="/codex-constellation" className="group">
          ...
          <link_1.default href="/seven-crowns-transmission" className="group">
          ...
          <link_1.default href="/festival" className="group">
            <div className="flex items-center px-6 py-3 border border-gray-600 rounded-full hover:border-purple-400 transition-colors">
              <span className="text-2xl mr-2">🎭</span>
              <span className="text-gray-300 group-hover:text-white">Festival Portal</span>
            </div>
          </link_1.default>
          <link_1.default href="/signals" className="group">
          ...
          <link_1.default href="/capsules" className="group">
...
exports.default = DashboardSelector;
