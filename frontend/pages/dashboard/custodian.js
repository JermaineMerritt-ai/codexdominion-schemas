...
var CustodianDashboard = function () {
    var _a = (0, react_1.useState)('artifacts'), activeTab = _a[0], setActiveTab = _a[1];
    var _b = (0, react_1.useState)([]), artifacts = _b[0], setArtifacts = _b[1];
    var _c = (0, react_1.useState)([]), crowns = _c[0], setCrowns = _c[1];
    ...
    var StatusBadge = function (_a) {
        ...
        return (<span className={"px-2 py-1 rounded-full text-xs font-medium ".concat(colors[status])}>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900">
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <link_1.default href="/dashboard-selector" className="text-purple-300 hover:text-white mr-4">
                  ← Back
                </link_1.default>
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <TabButton id="artifacts" label="Artifacts" icon="📦" active={activeTab === 'artifacts'}/>
            <TabButton id="crowns" label="Infrastructure Crowns" icon="👑" active={activeTab === 'crowns'}/>
            <TabButton id="inscriptions" label="Inscription Tools" icon="✒️" active={activeTab === 'inscriptions'}/>
            <TabButton id="audit" label="Audit Lineage" icon="🔍" active={activeTab === 'audit'}/>
          </div>

          {/* Artifacts Tab */}
          {activeTab === 'artifacts' && (<div className="space-y-6">
              <div className="bg-black bg-opacity-20 rounded-xl border border-purple-800 p-6">
                ...
                <div className="grid gap-4">
                  {artifacts.map(function (artifact) { return (<div key={artifact.id} className="bg-gray-800 bg-opacity-50 rounded-lg p-4 border border-gray-700 hover:border-purple-500 transition-colors">
                      <div className="flex items-center justify-between">
          ...
          {activeTab === 'crowns' && (<div className="space-y-6">
              <div className="bg-black bg-opacity-20 rounded-xl border border-purple-800 p-6">
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  {crowns.map(function (crown, index) { return (<div key={index} className="bg-gray-800 bg-opacity-50 rounded-lg p-6 border border-gray-700">
                      ...
                      <div className="space-y-3 text-sm">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1">
                            {crown.dependencies.map(function (dep, i) { return (<span key={i} className="px-2 py-1 bg-purple-800 text-purple-200 rounded text-xs">
                                {dep}
                              </span>); })}
                          </div>
                        </div>
          ...
          {activeTab === 'inscriptions' && (<div className="space-y-6">
              <div className="bg-black bg-opacity-20 rounded-xl border border-purple-800 p-6">
                <h2 className="text-2xl font-bold text-white flex items-center mb-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <select className="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white" title="Select an option">
                      ...
                      <div>
                        ...
                        <textarea className="w-full p-3 bg-gray-800 border border-gray-600 rounded-lg text-white h-32" placeholder="Enter sacred inscription..."/>
                      </div>
          ...
          {activeTab === 'audit' && (<div className="space-y-6">
                ...
                },
                {
                    ...
                    user: 'heir_dashboard',
            ...
            ].map(function (log, i) { return (<div key={i} className="flex items-center justify-between p-3 bg-gray-700 bg-opacity-50 rounded">
                          <div className="flex items-center">
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <span className={"w-2 h-2 rounded-full ".concat(log.type === 'ceremony'
                    ? 'bg-purple-500'
...
exports.default = CustodianDashboard;
