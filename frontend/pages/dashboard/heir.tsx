        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center">
            <span className="text-3xl mr-3">
              {step.completed ? '✅' : typeIcons[step.type]}
            </span>
            <div>
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="bg-black bg-opacity-20 rounded-xl border border-amber-700 p-6 mb-8">
            <div className="flex items-center justify-between mb-4">
              ...
              <span className="text-amber-300 font-medium">{inductionProgress.toFixed(0)}% Complete</span>
            </div>
            <div className="w-full bg-gray-700 rounded-full h-3 mb-4">
              <div 
                className="bg-gradient-to-r from-amber-500 to-orange-500 h-3 rounded-full transition-all duration-500"
                style={{ width: `${inductionProgress}%` }}
              ></div>
            </div>
            ...
            <div className="space-y-6">
              <div className="bg-black bg-opacity-20 rounded-xl border border-amber-700 p-6">
                ...
                <div className="space-y-4">
                  {banners.map((banner) => (
                    <div key={banner.id} className="bg-gradient-to-r from-amber-800/30 to-orange-800/30 rounded-xl p-6 border border-amber-600">
                ...
                {inductionProgress < 100 && (
                  <div className="mt-8 p-6 bg-amber-900/30 rounded-xl border border-amber-600">
                    ...
                    <p className="text-gray-300 mb-4">
                      Complete your remaining induction ceremonies to unlock full heir privileges and access to advanced heritage documentation.
                    </p>
                    ...
                    <div key={event.id} className="relative">
                      ...
                      <div className="flex items-start space-x-4">
                        <div className={`
                          ...
                          ${event.significance === 'foundational' ? 'bg-purple-600 border-purple-400' :
                            event.significance === 'expansion' ? 'bg-blue-600 border-blue-400' :
                        ...
                        <div className="flex-1 bg-gray-800 bg-opacity-50 rounded-lg p-6">
                          ...
                          <div className="flex flex-wrap items-center gap-4">
                            <span className={`
                              ...
                              ${event.significance === 'foundational' ? 'bg-purple-500/20 text-purple-300' :
                                event.significance === 'expansion' ? 'bg-blue-500/20 text-blue-300' :
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {event.participants.map((participant, i) => (
                                <span key={i} className="text-sm text-amber-300">
                                  {participant}{i < event.participants.length - 1 ? ', ' : ''}
                                </span>
                              ))}
                            </div>
                          </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {[
                        { date: '2025-11-15', name: 'Full Moon Blessing', type: 'monthly' },
                        { date: '2025-12-21', name: 'Winter Solstice Gathering', type: 'seasonal' },
                        { date: '2025-12-31', name: 'Year Transition Rite', type: 'annual' }
                      ].map((ceremony, i) => (
                        <div key={i} className="p-4 bg-gray-800 bg-opacity-50 rounded-lg border border-gray-600">
                          <div className="flex justify-between items-center">
                            ...
                            <span className={`
                              ...
                              ${ceremony.type === 'seasonal' ? 'bg-amber-500 text-white' :
                                ceremony.type === 'monthly' ? 'bg-blue-500 text-white' :
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      {[
                        { date: '2025-10-31', name: 'Harvest Festival', participation: 'Observer' },
                        { date: '2025-10-15', name: 'New Moon Silence', participation: 'Participant' },
                        { date: '2025-09-22', name: 'Autumn Equinox', participation: 'Initiate' }
                      ].map((event, i) => (
                        <div key={i} className="p-4 bg-gray-800 bg-opacity-50 rounded-lg border border-gray-600">
                          <div className="flex justify-between items-center">
                            <div>
