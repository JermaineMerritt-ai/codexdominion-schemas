      ...
      setCapsules([
        {
          ...
          description:
            'Essential tools and knowledge for beginning your journey into digital independence.',
          category: 'Education',
          price: 49.99,
          rating: 4.8,
        ...
        },
        {
          ...
          description:
            'Professional-grade encryption tools and methodologies for secure communications.',
          category: 'Security',
          price: 199.99,
          rating: 4.9,
          image: '/api/placeholder/300/200',
        ...
        },
        {
          ...
          description:
            'Complete toolkit for building intelligent applications with ethical AI principles.',
      ...
      setScrolls([
        {
          ...
          excerpt:
            'Understanding the fundamental principles that guide true technological independence...',
          author: 'Codex Sage',
          readTime: '12 min',
          category: 'Philosophy',
        ...
        },
        {
          ...
          excerpt:
            'Practical approaches to creating technology that serves humanity rather than enslaving it...',
        ...
        },
        {
          ...
          excerpt:
            'How programming becomes a ceremonial practice when approached with reverence and intention...',
          author: 'Code Mystic',
          readTime: '15 min',
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-4 gap-4">
                {[
                  ...
                  <div
                    key={i}
                    className="bg-gray-800 bg-opacity-30 rounded-lg p-4 text-center hover:bg-opacity-50 transition-all cursor-pointer"
                  >
                  ...
                  {[
                    {
                      ...
                      description:
                        'Pre-built AI models, training datasets, and development frameworks',
                      icon: '🛠️',
                      itemCount: 25,
                    },
                    {
                      ...
                      description:
                        'Enterprise-ready AI applications for automation and intelligence',
                      icon: '💼',
                      itemCount: 18,
                    },
                    {
                      ...
                      description:
                        'AI-powered tools for content creation, design, and media production',
                      icon: '🎨',
                      itemCount: 32,
                    },
                    {
                    ...
                    <div
                      key={i}
                      className="bg-gray-800 bg-opacity-50 rounded-lg p-6 border border-gray-700 hover:border-emerald-500 transition-all"
                    >
