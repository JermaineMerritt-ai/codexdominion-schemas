...
const CustomerDashboard: NextPage = () => {
  ...
  const [showCustodianWelcome, setShowCustodianWelcome] = useState(false);
  ...
  const TabButton: React.FC<{ id: string; label: string; icon: string; active: boolean }> = 
  ...
  const CapsuleCard: React.FC<{ capsule: FeaturedCapsule }> = ({ capsule }) => (
    <div className="bg-gray-800 bg-opacity-50 rounded-xl border border-gray-700 overflow-hidden hover:border-emerald-500 transition-all duration-300 group">
  ...
  const ScrollCard: React.FC<{ scroll: Scroll }> = ({ scroll }) => (
    <div className="bg-gray-800 bg-opacity-50 rounded-lg p-6 border border-gray-700 hover:border-emerald-500 transition-all duration-300">
      <div className="flex items-center justify-between mb-3">
        <span className="text-xs text-emerald-400 font-medium uppercase tracking-wide">
          {scroll.category}
        </span>
        <span className="text-xs text-gray-400">
          {scroll.readTime} read
        </span>
      </div>
  ...
  const AvatarCard: React.FC<{ avatar: OnboardingAvatar }> = ({ avatar }) => (
    <div className={`
      bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700 text-center
      ${avatar.available ? 'hover:border-emerald-500' : 'opacity-60'}
    ...
    `}>
      ...
      {avatar.available ? (
        ...
        <button className="w-full py-2 bg-gray-600 text-gray-400 rounded-lg cursor-not-allowed">
          Currently Busy
        </button>
      )}
    </div>
  ...
  const CustodianWelcomeModal: React.FC = () => (
      ...
      <div className="bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-2xl max-w-2xl w-full border-2 border-yellow-500 shadow-2xl shadow-yellow-500/30">
        ...
        <div className="px-8 py-6 space-y-6 text-gray-100">
          <div className="text-center mb-6">
            <p className="text-lg leading-relaxed">
              Your offering has been received, and your induction is complete.<br/>
          ...
          <div className="space-y-4 text-left">
            ...
            <ul className="space-y-3 ml-4">
              <li className="flex items-start">
                ...
                <span><strong>Scrolls</strong> carry wisdom across generations.</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-400 mr-3 mt-1">🃏</span>
                <span><strong>Decks</strong> weave stories into daily practice.</span>
              </li>
              <li className="flex items-start">
                <span className="text-yellow-400 mr-3 mt-1">👑</span>
                <span><strong>Ceremonies</strong> crown your participation in the eternal rhythm.</span>
              </li>
            </ul>
            ...
            <div className="border-l-4 border-yellow-500 pl-6 my-6 bg-black bg-opacity-30 rounded-r-lg py-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-start">
                  ...
                  Your account is your <strong className="text-emerald-300">onboarding avatar</strong>, a vessel of inheritance.
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-400 mr-3">•</span>
                  Your purchases are <strong className="text-emerald-300">acts of legacy</strong>, binding commerce to ceremony.
                </li>
                <li className="flex items-start">
                  <span className="text-emerald-400 mr-3">•</span>
                  Your presence is a <strong className="text-emerald-300">blessing</strong>, ensuring the flame shines across nations and ages.
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="px-8 pb-8">
          <div className="flex space-x-4">
            <Link href="/dashboard/custodian" className="flex-1">
            ...
            <button 
              onClick={() => setShowCustodianWelcome(false)}
              className="px-6 py-4 border-2 border-gray-600 text-gray-300 rounded-xl hover:border-yellow-500 hover:text-white transition-all duration-300"
            >
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-emerald-800 via-teal-800 to-cyan-900 flex items-center justify-center">
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <Link href="/dashboard-selector" className="text-emerald-300 hover:text-white mr-4">
                  ← Back
                </Link>
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="bg-gradient-to-r from-emerald-600 to-teal-600 rounded-xl p-8 mb-8 text-white">
            ...
            <p className="text-lg opacity-90 mb-6">
              Discover curated tools, knowledge, and services designed to enhance your digital sovereignty journey.
            </p>
            <div className="flex flex-wrap gap-4">
              <Link href="https://aistorelab.com" target="_blank" rel="noopener noreferrer">
              ...
              <button 
                onClick={() => setShowCustodianWelcome(true)}
                className="px-6 py-3 bg-gradient-to-r from-yellow-500 to-yellow-600 text-black font-bold rounded-lg hover:from-yellow-400 hover:to-yellow-500 transition-all duration-300 shadow-lg"
              >
                🕯️ Become Custodian
              </button>
            </div>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <TabButton 
              id="featured" 
              label="Featured Capsules" 
              icon="💊" 
              active={activeTab === 'featured'} 
            />
            <TabButton 
              id="scrolls" 
              label="Knowledge Scrolls" 
              icon="📜" 
              active={activeTab === 'scrolls'} 
            />
            <TabButton 
              id="avatars" 
              label="Onboarding Avatars" 
              icon="🧚‍♀️" 
            ...
            <div className="space-y-8">
              ...
              <div className="grid md:grid-cols-4 gap-4">
                {[
                  ...
                  <div key={i} className="bg-gray-800 bg-opacity-30 rounded-lg p-4 text-center hover:bg-opacity-50 transition-all cursor-pointer">
              ...
              <div className="bg-black bg-opacity-20 rounded-xl border border-teal-700 p-6">
                ...
                <div className="mt-8 bg-gradient-to-r from-teal-800/50 to-emerald-800/50 rounded-xl p-8 border border-teal-600">
                  ...
                  <p className="text-gray-300 mb-6">
                    A comprehensive exploration of what it means to achieve true digital independence in the modern age. 
                    This extensive guide covers philosophical foundations, practical implementations, and real-world case studies.
                  </p>
                  <div className="flex items-center justify-between">
            ...
            <div className="space-y-6">
              <div className="bg-black bg-opacity-20 rounded-xl border border-teal-700 p-6">
                ...
                <p className="text-gray-300 mb-8">
                  Get personalized guidance from our AI-powered avatars. Each specializes in different aspects of your journey 
                  into digital sovereignty and can provide tailored recommendations based on your needs and experience level.
                </p>
              ...
              <div className="bg-black bg-opacity-20 rounded-xl border border-teal-700 p-6">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-center space-y-4 text-gray-100">
                      <p className="text-lg leading-relaxed italic">
                        ...
                        <Link href="https://aistorelab.com" target="_blank" rel="noopener noreferrer" className="text-yellow-400 hover:text-yellow-300 underline font-medium">
                          aistorelab.com
                        </Link>.
                      </p>
                      ...
                      <p className="text-base leading-relaxed">
                        ...
                        but a <span className="text-emerald-300 font-medium">living artifact</span>, inscribed into the Codex Dominion.
                      </p>
                ...
                <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl p-8 text-white mb-8">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg opacity-90 mb-6">
                        Premium AI tools, templates, and services designed for professionals and enterprises. 
                        Access cutting-edge technology that puts you ahead of the curve.
                      </p>
                      <Link href="https://aistorelab.com" target="_blank" rel="noopener noreferrer">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {[
                    ...
                    <div key={i} className="bg-gray-800 bg-opacity-50 rounded-lg p-6 border border-gray-700 hover:border-emerald-500 transition-all">
                      <div className="text-3xl mb-4">{category.icon}</div>
                      <h3 className="text-lg font-semibold text-white mb-2">{category.name}</h3>
                      <p className="text-gray-400 text-sm mb-4">{category.description}</p>
                      <div className="flex items-center justify-between">
                        <span className="text-emerald-400 font-medium">{category.itemCount} products</span>
                ...
                <div className="mt-8 bg-gradient-to-r from-yellow-600 to-orange-600 rounded-xl p-6 text-white">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <p className="text-sm opacity-90">Get started with our curated selection of essential AI tools at half price.</p>
                    </div>
                    <div>
                      <h4 className="font-semibold mb-2">Enterprise Package - Free Trial</h4>
                      <p className="text-sm opacity-90">30-day free access to premium business solutions for qualifying organizations.</p>
                    </div>
                  </div>
                </div>
              </div>
