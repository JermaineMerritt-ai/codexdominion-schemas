...
const SevenCrownsTransmission: NextPage = () => {
  ...
  const crowns = [
    {
      ...
      description:
        'The sovereign Bulletin, luminous and eternal, transmitting cycles and rites across the world.',
      icon: '👑',
    ...
    },
    {
      ...
      description:
        'The marketplace of offerings, where commerce and ceremony are bound together in induction.',
      icon: '🛍️',
    ...
    },
    {
      ...
      description:
        'The sandbox flame, playful and provisional, where new rites and dashboards are tested.',
      icon: '⚗️',
    ...
    },
    {
      ...
      description:
        "The Custodian's voice, radiant in essays and proclamations, echoing the Codex into discourse.",
      icon: '✍️',
    ...
    },
    {
      ...
      description:
        'The participatory flame, where heirs and councils inscribe proclamations, silences, and blessings.',
      icon: '🏛️',
    ...
    },
    {
      ...
      description:
        'The rare flame, offering exclusive artifacts, reliquaries, and ceremonial kits.',
      icon: '💎',
    ...
    },
    {
      ...
      description:
        'The teaching flame, inducting families and heirs into stewardship through courses and guidebooks.',
      icon: '📚',
  ...
  const CrownRevealRoot = styled.div<{ delay: number; revealed: boolean }>`
    transform: ${({ revealed }) => (revealed ? 'translateY(0)' : 'translateY(2rem)')};
    opacity: ${({ revealed }) => (revealed ? 1 : 0)};
    transition: all 1s;
    transition-delay: ${({ delay }) => delay}ms;
  `;

  const CrownReveal: React.FC<{
    crown: (typeof crowns)[0];
    index: number;
    revealed: boolean;
  }> = ({ crown, index, revealed }) => (
    <CrownRevealRoot delay={crown.delay} revealed={revealed}>
      <div
        className={`bg-gradient-to-br ${crown.color} rounded-xl p-6 text-white relative overflow-hidden group`}
      >
        {/* Sacred Glow Effect */}
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-black relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          {(() => {
            const FloatingSacredSymbol = styled.div<{
              left: number;
              top: number;
              delay: string;
              duration: string;
