  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-800 to-black relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-25">
        <div
          className="absolute top-1/8 left-1/8 w-72 h-72 bg-gold-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '20s' }}
        />
        <div
          className="absolute bottom-1/8 right-1/8 w-80 h-80 bg-purple-400/20 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '25s', animationDelay: '5s' }}
        />
        <div
          className="absolute top-1/2 right-1/5 w-96 h-96 bg-indigo-400/15 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '30s', animationDelay: '10s' }}
        />
        <div
          className="absolute bottom-1/3 left-1/5 w-88 h-88 bg-white/12 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '35s', animationDelay: '15s' }}
        />
        <div
          className="absolute top-2/3 left-1/10 w-64 h-64 bg-cyan-400/18 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '40s', animationDelay: '20s' }}
        />
        <div
          className="absolute bottom-1/2 right-1/10 w-76 h-76 bg-emerald-400/10 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '45s', animationDelay: '25s' }}
        />
        <div
          className="absolute top-1/4 left-1/3 w-68 h-68 bg-rose-400/8 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '50s', animationDelay: '30s' }}
        />
      </div>
    </div>
  );
