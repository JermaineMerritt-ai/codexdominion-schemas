        ...
        >
          <div
            ...
            style={{
              filter:
                finalEchoPhase === i
                  ? `drop-shadow(0 0 50px rgba(255, 255, 255, ${finalEchoIntensity}))`
                  : 'none',
            }}
          >
            🌌
      ...
      {finalRealms.map((realm, index) => (
        ...
        >
          <div
            ...
            style={{
              filter:
                finalRealmPhase === index ? 'drop-shadow(0 0 50px rgba(255, 215, 0, 1.2))' : 'none',
            }}
          >
            {realm.icon}
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gold-600 to-black relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-15">
        <div
          className="absolute top-1/12 left-1/12 w-48 h-48 bg-white/35 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '25s' }}
        />
        <div
          className="absolute bottom-1/12 right-1/12 w-56 h-56 bg-gold-400/30 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '32s', animationDelay: '3s' }}
        />
        <div
          className="absolute top-1/2 right-1/8 w-72 h-72 bg-amber-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '40s', animationDelay: '6s' }}
        />
        <div
          className="absolute bottom-1/5 left-1/8 w-64 h-64 bg-yellow-400/20 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '48s', animationDelay: '9s' }}
        />
        <div
          className="absolute top-2/3 left-1/15 w-40 h-40 bg-orange-400/28 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '56s', animationDelay: '12s' }}
        />
        <div
          className="absolute bottom-1/2 right-1/15 w-52 h-52 bg-red-400/15 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '64s', animationDelay: '15s' }}
        />
        <div
          className="absolute top-1/4 left-1/5 w-60 h-60 bg-purple-400/18 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '72s', animationDelay: '18s' }}
        />
        <div
          className="absolute bottom-3/4 right-1/5 w-44 h-44 bg-blue-400/22 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '80s', animationDelay: '21s' }}
        />
        <div
          className="absolute top-1/8 left-1/3 w-36 h-36 bg-cyan-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '88s', animationDelay: '24s' }}
        />
        <div
          className="absolute bottom-1/8 right-1/3 w-68 h-68 bg-emerald-400/12 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '96s', animationDelay: '27s' }}
        />
      </div>
    </div>
  );
