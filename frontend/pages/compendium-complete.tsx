  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gold-400 via-white to-purple-700 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-18">
        <div
          className="absolute top-1/20 left-1/20 w-36 h-36 bg-gold-400/40 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '35s' }}
        />
        <div
          className="absolute bottom-1/20 right-1/20 w-44 h-44 bg-white/35 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '42s', animationDelay: '3s' }}
        />
        <div
          className="absolute top-1/2 right-1/12 w-52 h-52 bg-purple-400/30 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '50s', animationDelay: '6s' }}
        />
        <div
          className="absolute bottom-1/6 left-1/12 w-48 h-48 bg-amber-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '58s', animationDelay: '9s' }}
        />
        <div
          className="absolute top-2/3 left-1/20 w-32 h-32 bg-green-400/32 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '65s', animationDelay: '12s' }}
        />
        <div
          className="absolute bottom-1/2 right-1/20 w-40 h-40 bg-cyan-400/28 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '72s', animationDelay: '15s' }}
        />
        <div
          className="absolute top-1/4 left-1/6 w-56 h-56 bg-red-400/22 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '80s', animationDelay: '18s' }}
        />
        <div
          className="absolute bottom-3/4 right-1/6 w-28 h-28 bg-blue-400/30 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '88s', animationDelay: '21s' }}
        />
      </div>
    </div>
  );
