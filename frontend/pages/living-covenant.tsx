      ...
      {realms.map((realm, index) => (
        ...
        >
          <div
            ...
            style={{
              filter:
                activeRealm === index ? 'drop-shadow(0 0 20px rgba(255, 215, 0, 0.8))' : 'none',
            }}
          >
            {realm.icon}
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-orange-900 to-yellow-900 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-30">
        <div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-yellow-400/20 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '6s' }}
        />
        <div
          className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-orange-400/15 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '9s', animationDelay: '3s' }}
        />
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-amber-500/10 rounded-full filter blur-3xl animate-pulse"
