  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gold-600 via-white to-black relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-12">
        <div
          className="absolute top-1/20 left-1/20 w-32 h-32 bg-gold-400/40 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '30s' }}
        />
        <div
          className="absolute bottom-1/20 right-1/20 w-40 h-40 bg-white/35 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '38s', animationDelay: '2s' }}
        />
        <div
          className="absolute top-1/2 right-1/12 w-48 h-48 bg-amber-400/30 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '45s', animationDelay: '4s' }}
        />
        <div
          className="absolute bottom-1/6 left-1/12 w-44 h-44 bg-yellow-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '52s', animationDelay: '6s' }}
        />
        <div
          className="absolute top-2/3 left-1/20 w-28 h-28 bg-orange-400/32 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '60s', animationDelay: '8s' }}
        />
        <div
          className="absolute bottom-1/2 right-1/20 w-36 h-36 bg-red-400/20 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '68s', animationDelay: '10s' }}
        />
        <div
          className="absolute top-1/4 left-1/6 w-52 h-52 bg-purple-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '75s', animationDelay: '12s' }}
        />
        <div
          className="absolute bottom-3/4 right-1/6 w-32 h-32 bg-blue-400/28 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '82s', animationDelay: '14s' }}
        />
        <div
          className="absolute top-1/8 left-1/4 w-24 h-24 bg-cyan-400/30 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '90s', animationDelay: '16s' }}
        />
        <div
          className="absolute bottom-1/8 right-1/4 w-56 h-56 bg-emerald-400/18 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '98s', animationDelay: '18s' }}
        />
        <div
          className="absolute top-1/6 left-1/2 w-64 h-64 bg-teal-400/15 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '105s', animationDelay: '20s' }}
        />
        <div
          className="absolute bottom-1/6 right-1/2 w-20 h-20 bg-lime-400/35 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '112s', animationDelay: '22s' }}
        />
      </div>
    </div>
  );
