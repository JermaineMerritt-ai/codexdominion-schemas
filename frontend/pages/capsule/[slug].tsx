...
export default function CapsulePage() {
  ...
  const [userRole, setUserRole] = useState<string>('heir'); // Default role
    ...
    <div style={{ padding: 24 }}>
      <div className="capsule-header">
        ...
        <div className="meta-info">
          <p><strong>Capsule:</strong> <code>{slug}</code></p>
          <p><strong>Generated:</strong> {new Date(artifact.generated_at).toLocaleString()}</p>
          {artifact.execution_id && (
            <p><strong>Execution ID:</strong> <code>{artifact.execution_id}</code></p>
          )}
          {artifact.status && (
      ...
      <div className="content-grid">
        ...
        <div className="picks-section">
          ...
          <div className="picks-grid">
            {artifact.picks.map((pick: Pick, i: number) => (
                ...
                <div className="pick-header">
                  ...
                  <div className="pick-meta">
                    ...
                    <span className="weight">
                      {(pick.target_weight * 100).toFixed(2)}%
                    </span>
                  </div>
                </div>
