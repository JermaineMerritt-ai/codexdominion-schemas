    ...
    <Layout>
      <div className="treasury-page">
        <header className="page-header">
          ...
          <button onClick={() => setShowNewTransaction(true)} className="primary-button">
            + New Transaction
          </button>
        </header>
          ...
          <section className="summary-section">
            ...
            <div className="summary-grid">
              ...
              <div className="summary-card">
                <h4>Daily Change</h4>
                <p
                  className={`summary-value ${treasuryData.treasury.summary.daily_change >= 0 ? 'positive' : 'negative'}`}
                >
              ...
              <div className="summary-card">
                ...
                <p
                  className={`summary-value ${treasuryData.treasury.summary.monthly_change >= 0 ? 'positive' : 'negative'}`}
                >
