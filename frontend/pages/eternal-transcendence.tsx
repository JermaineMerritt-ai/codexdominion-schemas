  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-black relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-30">
        <div
          className="absolute top-1/6 left-1/6 w-80 h-80 bg-white/20 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '18s' }}
        />
        <div
          className="absolute bottom-1/6 right-1/6 w-72 h-72 bg-purple-400/15 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '22s', animationDelay: '6s' }}
        />
        <div
          className="absolute top-1/2 right-1/4 w-88 h-88 bg-indigo-400/12 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '28s', animationDelay: '12s' }}
        />
        <div
          className="absolute bottom-1/3 left-1/4 w-96 h-96 bg-cyan-400/10 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '35s', animationDelay: '18s' }}
        />
        <div
          className="absolute top-2/3 left-1/8 w-64 h-64 bg-gold-400/18 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '40s', animationDelay: '25s' }}
        />
        <div
          className="absolute bottom-1/2 right-1/8 w-76 h-76 bg-emerald-400/8 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '45s', animationDelay: '30s' }}
        />
      </div>
    </div>
  );
