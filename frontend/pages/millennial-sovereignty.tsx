      ...
      {governanceElements.map((element, index) => (
        ...
        >
          <div
            ...
            style={{
              filter:
                governancePhase === index ? 'drop-shadow(0 0 30px rgba(255, 215, 0, 0.9))' : 'none',
            }}
          >
            {element.icon}
          </div>
      ...
      {phases.map((phase, index) => (
        ...
        >
          <div
            ...
            style={{
              filter:
                temporalPhase === index ? 'drop-shadow(0 0 20px rgba(255, 215, 0, 0.8))' : 'none',
            }}
          >
            {phase.icon}
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-amber-900 via-gold-800 to-yellow-900 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-35">
        <div
          className="absolute top-1/4 left-1/4 w-96 h-96 bg-gold-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '15s' }}
        />
        <div
          className="absolute bottom-1/4 right-1/4 w-88 h-88 bg-amber-400/20 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '20s', animationDelay: '7s' }}
        />
        <div
          className="absolute top-1/2 right-1/3 w-72 h-72 bg-yellow-400/18 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '25s', animationDelay: '12s' }}
        />
        <div
          className="absolute bottom-1/2 left-1/3 w-80 h-80 bg-gold-500/15 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '30s', animationDelay: '18s' }}
        />
        <div
          className="absolute top-2/3 left-1/5 w-64 h-64 bg-amber-500/12 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '35s', animationDelay: '25s' }}
        />
      </div>
    </div>
  );
