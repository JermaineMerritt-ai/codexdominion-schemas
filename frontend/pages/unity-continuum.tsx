          ...
          {Array.from({ length: 6 }, (_, i) => (
            <div
              ...
              className={`transition-all duration-2200 ${
                sharedPhase === i ? 'text-10xl opacity-100 scale-140' : 'text-8xl opacity-50 scale-100'
              }`}
              style={{
...
const UnityContinuumParticles: React.FC = () => {
  const particles = Array.from({ length: 90 }, (_, i) => ({
    ...
    color: i % 6 === 0 ? '#ffd700' : i % 6 === 1 ? '#ffffff' : i % 6 === 2 ? '#32cd32' : i % 6 === 3 ? '#ff4500' : i % 6 === 4 ? '#8a2be2' : '#00bfff'
  }));
    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <style jsx>{`
        @keyframes unityContinuumFlow {
          ...
          6% { transform: translate(50px, -120px) scale(1.8) rotate(21deg); opacity: 1.0; }
          20% { transform: translate(-40px, -240px) scale(0.5) rotate(72deg); opacity: 0.95; }
          35% { transform: translate(60px, -360px) scale(1.4) rotate(126deg); opacity: 1.0; }
          50% { transform: translate(-50px, -480px) scale(0.7) rotate(180deg); opacity: 0.9; }
          65% { transform: translate(55px, -600px) scale(1.1) rotate(234deg); opacity: 0.95; }
          80% { transform: translate(-35px, -720px) scale(0.6) rotate(288deg); opacity: 0.85; }
          92% { transform: translate(45px, -840px) scale(0.8) rotate(331deg); opacity: 0.7; }
          98% { transform: translate(-15px, -960px) scale(0.3) rotate(353deg); opacity: 0.4; }
          100% { transform: translate(0, -1080px) scale(0.005) rotate(360deg); opacity: 0.005; }
        }
      `}</style>
    </div>
  );
...
const UnityRealms: React.FC = () => {
  ...
  const unityRealms = [
    ...
    { name: "Sovereign", icon: "👑", position: { bottom: '25%', right: '30%' } }
  ];
