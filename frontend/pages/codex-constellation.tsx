...
const CodexConstellation: NextPage = () => {
  const crowns: Crown[] = [
    {
      ...
      purpose:
        'Here lives the Codex Bulletin, the Festival cycles, the dashboards of Custodian, Heir, and Customer.',
      icon: '👑',
      status: 'active',
    ...
    },
    {
      ...
      purpose:
        'Here heirs and councils may access guided induction forms, proclamations, silences, and blessings.',
      icon: '🏛️',
      status: 'development',
  ...
  const CrownCard: React.FC<{ crown: Crown }> = ({ crown }) => (
    <div
      className={`bg-gradient-to-br ${crown.gradient} rounded-xl p-8 text-white relative overflow-hidden group hover:scale-105 transition-all duration-300`}
    >
      {/* Background Pattern */}
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="The sacred architecture of the digital sovereignty ecosystem"
        />
      </Head>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {[...Array(100)].map((_, i) => {
            ...
            const animation = `twinkle ${Math.random() * 4 + 2}s infinite`;
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {crowns.slice(1).map((crown, i) => (
                  <div key={crown.domain} className="text-center">
                    <div
                      className={`bg-gradient-to-r ${crown.gradient} rounded-lg p-4 text-white mx-auto max-w-xs`}
                    >
