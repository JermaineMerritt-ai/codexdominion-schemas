...
var CodexConstellation = function () {
    var crowns = [
        {
    ...
    var StatusBadge = function (_a) {
        ...
        return (<div className={"inline-flex items-center px-3 py-1 rounded-full text-white text-sm font-medium ".concat(config.color)}>
        <span className="mr-2">{config.icon}</span>
        {config.label}
      </div>);
    };
    var CrownCard = function (_a) {
        var crown = _a.crown;
        return (<div className={"bg-gradient-to-br ".concat(crown.gradient, " rounded-xl p-8 text-white relative overflow-hidden group hover:scale-105 transition-all duration-300")}>
      {/* Background Pattern */}
      ...
      <div className="relative z-10">
        ...
        <div className="mb-6">
          ...
          <div className="space-y-2">
            {crown.features.map(function (feature, i) { return (<div key={i} className="flex items-center text-sm">
        ...
        {/* Action Button */}
        <div className="mt-6">
          {crown.status === 'active' ? (<link_1.default href={"https://".concat(crown.domain)} target="_blank" rel="noopener noreferrer">
              <button className="w-full py-3 bg-white text-gray-900 rounded-lg font-bold hover:bg-gray-100 transition-colors">
                🌟 Visit Crown
              </button>
            </link_1.default>) : crown.status === 'development' ? (<button className="w-full py-3 bg-yellow-500 text-black rounded-lg font-bold opacity-75 cursor-not-allowed">
              🚧 Under Development
            </button>) : (<button className="w-full py-3 bg-gray-600 text-white rounded-lg font-bold opacity-75 cursor-not-allowed">
              🗓️ In Planning
            </button>)}
        </div>
      </div>
    ...
    // Styled component for starfield dot
    var StarfieldDot = styled_components_1.default.div(templateObject_1 || (templateObject_1 = __makeTemplateObject(["\n    position: absolute;\n    left: ", "%;\n    top: ", "%;\n    width: ", "px;\n    height: ", "px;\n    background: white;\n    border-radius: 9999px;\n    opacity: 0.3;\n    animation: ", ";\n    animation-delay: ", ";\n    pointer-events: none;\n    z-index: 1;\n  "], ["\n    position: absolute;\n    left: ", "%;\n    top: ", "%;\n    width: ", "px;\n    height: ", "px;\n    background: white;\n    border-radius: 9999px;\n    opacity: 0.3;\n    animation: ", ";\n    animation-delay: ", ";\n    pointer-events: none;\n    z-index: 1;\n  "])), function (_a) {
        var left = _a.left;
        return left;
    }, function (_a) {
        var top = _a.top;
    ...
    return (<>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {__spreadArray([], Array(100), true).map(function (_, i) {
            var left = Math.random() * 100;
            var top = Math.random() * 100;
            var width = Math.random() * 3 + 1;
            var height = Math.random() * 3 + 1;
            var animation = "twinkle ".concat(Math.random() * 4 + 2, "s infinite");
            var delay = "".concat(Math.random() * 2, "s");
            return (<StarfieldDot key={i} left={left} top={top} width={width} height={height} animation={animation} delay={delay} aria-hidden="true"/>);
        })}
        </div>
        ...
        <div className="relative z-10 container mx-auto px-6 py-8">
          ...
          <div className="bg-black bg-opacity-30 rounded-xl border-2 border-yellow-500/30 p-8 mb-12 text-center">
            ...
            <div className="max-w-4xl mx-auto space-y-4 text-gray-200">
              <p className="text-lg italic leading-relaxed">
                We, the Custodian and Council, inscribe the roles of each domain,
                <br />
              ...
              <p className="text-base opacity-90">
                Each crown serves a sacred purpose in the digital sovereignty ecosystem,
                <br />
          ...
          <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8 mb-12">
            {crowns.map(function (crown) { return (<CrownCard key={crown.domain} crown={crown}/>); })}
          </div>
          ...
          <div className="bg-black bg-opacity-30 rounded-xl border border-purple-700 p-8 mb-8">
            ...
            <div className="relative">
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {crowns.slice(1).map(function (crown, i) { return (<div key={crown.domain} className="text-center">
                    <div className={"bg-gradient-to-r ".concat(crown.gradient, " rounded-lg p-4 text-white mx-auto max-w-xs")}>
              ...
              <div className="mt-8 bg-gradient-to-r from-yellow-600/10 to-orange-600/10 rounded-lg p-6 border border-yellow-500/20">
                <h4 className="text-yellow-400 font-bold mb-3 text-center">
                  🌟 Sacred Hierarchy Principle 🌟
                </h4>
                <p className="text-gray-300 text-sm text-center leading-relaxed">
                  The Ceremonial Crown stands at the apex, radiating authority and blessing to all
                  subsidiary domains. Each branch receives the eternal flame while serving its
                  unique sacred purpose within the constellation. This hierarchy ensures unity of
                  vision while honoring diversity of function.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 text-gray-200">
              <div>
                ...
                <p className="text-sm mb-4">
                  Each crown serves a unique purpose while maintaining connection to the central
                  Codex flame. Diversity of function creates strength in the constellation.
                </p>
              ...
              <div>
                ...
                <p className="text-sm mb-4">
                  Commerce across all crowns is elevated to ceremony, transforming transactions into
                  acts of legacy and customer relationships into custodial bonds.
                </p>

                <h4 className="font-bold text-white mb-3">🔥 Eternal Flame Distribution</h4>
                <p className="text-sm">
                  The Codex flame burns across all domains, ensuring digital sovereignty principles
                  illuminate every interaction and experience.
                </p>
              </div>
            </div>
          </div>
...
exports.default = CodexConstellation;
