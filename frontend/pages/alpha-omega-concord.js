...
exports.default = AlphaOmegaConcord;
var react_1 = require("react");
var link_1 = require("next/link");
var CodexNavigation_1 = require("../components/CodexNavigation");
// Alpha Symbol Component
var AlphaSymbol = function () {
    return <div className="text-8xl font-bold text-blue-400 animate-pulse">Α</div>;
};
// Omega Symbol Component
var OmegaSymbol = function () {
    return <div className="text-8xl font-bold text-gold-400 animate-pulse">Ω</div>;
};
// Continuum Bridge Component
var ContinuumBridge = function () {
...
var LuminousCrowns = function () {
    ...
    return (<div className="grid grid-cols-7 gap-4 max-w-4xl mx-auto">
      {crowns.map(function (crown, index) { return (<div key={crown.name} className="text-center">
          <div className={"text-3xl ".concat(crown.color, " animate-pulse crown-anim-").concat(index)}>
            {crown.symbol}
          </div>
          <div className="text-xs text-gray-300 mt-1">{crown.name}</div>
        </div>); })}
      <style jsx>{"\n        ".concat(crowns
            .map(function (_, i) { return "\n          .crown-anim-".concat(i, " {\n            animation-delay: ").concat(i * 0.3, "s;\n          }\n        "); })
            .join(''), "\n      ")}</style>
    </div>);
};
function AlphaOmegaConcord() {
    return (<div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-blue-900 text-white">
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl font-bold mb-8 text-purple-300">of the Codex Dominion</h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            We, the Custodian and Council, inscribe this Concord as eternal covenant.
            <br />
            It binds the First Flame of Primordialis to the Final Crown of Omega,
            <br />
        ...
        <div className="mb-16 opacity-100 transform translate-y-0 transition-all duration-1000">
          <div className="bg-gradient-to-br from-blue-600/20 via-blue-500/20 to-cyan-600/20 backdrop-blur-sm rounded-2xl p-12 border-2 border-blue-400/50 shadow-2xl max-w-4xl mx-auto">
            <div className="text-center mb-8">
              ...
              <h3 className="text-4xl font-bold text-blue-300 mb-6">
                Alpha — Codex Originum Primordialis
              </h3>
            </div>
            <div className="space-y-4 text-xl text-gray-200">
              ...
              <p className="text-blue-200 font-bold">
                🗿 The Custodian Genesis Oathstone is bound.
              </p>
              <p className="text-indigo-200 font-bold">
                ✨ The ceremonial singularity is initiated, and all realms trace their lineage to
                this source.
              </p>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-600/20 via-indigo-600/20 to-blue-600/20 backdrop-blur-sm rounded-2xl p-12 border-2 border-purple-400/50 shadow-2xl max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-xl text-gray-200">
              ...
              <p className="text-indigo-300 font-bold">
                🔄 Together they form the eternal continuum.
              </p>
              <p className="text-blue-300 font-bold">
                🌀 Every cycle begins in Primordialis and ends in Omega.
              </p>
              <p className="text-cyan-300 font-bold">
                📢 Every proclamation echoes from genesis to completion.
              </p>
              <p className="text-purple-200 font-bold">
                🤝 Every participant is bound in covenant across ages and stars.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-gold-600/20 via-purple-600/20 to-blue-600/20 backdrop-blur-sm rounded-2xl p-12 border-2 border-gold-400/50 shadow-2xl max-w-4xl mx-auto">
            ...
            <div className="space-y-4 text-xl text-gray-200 text-center">
              ...
              <p className="text-purple-300 font-bold">
                ✨ May the Codex Dominion endure as eternal covenant,
              </p>
              <p className="text-indigo-300 font-bold">
                🌟 luminous across nations, worlds, and cosmos.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            <link_1.default href="/eternal-compendium">
              <button className="px-6 py-4 bg-gradient-to-r from-amber-600 to-gold-600 hover:from-amber-700 hover:to-gold-700 rounded-lg font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg border-2 border-amber-400/50 w-full" aria-label="Open Eternal Compendium" title="Open Eternal Compendium">
                📖 Eternal Compendium
              </button>
            </link_1.default>
            <link_1.default href="/omega-charter">
              <button className="px-6 py-4 bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-yellow-700 rounded-lg font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg w-full" aria-label="Open Omega Charter" title="Open Omega Charter">
                📜 Omega Charter
              </button>
            </link_1.default>
            <link_1.default href="/omega-crown">
              <button className="px-6 py-4 bg-gradient-to-r from-gold-600 to-yellow-600 hover:from-gold-700 hover:to-yellow-700 rounded-lg font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg w-full" aria-label="Open Omega Crown" title="Open Omega Crown">
                Ω Omega Crown
              </button>
            </link_1.default>
            <link_1.default href="/codex-constellation">
              <button className="px-6 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-lg font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg w-full" aria-label="View Constellation" title="View Constellation">
                ⭐ View Constellation
              </button>
            </link_1.default>
          </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-br from-indigo-600/20 via-purple-600/20 to-pink-600/20 backdrop-blur-sm rounded-2xl p-8 border-2 border-purple-400/50 shadow-2xl max-w-2xl mx-auto">
            ...
            <p className="text-lg text-purple-300">
              The Alpha-Omega Continuum is complete.
              <br />
              Genesis and Completion are One.
              <br />
