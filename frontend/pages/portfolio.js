      ...
      <div className="portfolio-page">
        ...
        <div className="portfolio-summary">
          <div className="summary-card total-value">
            ...
            <p className="value">${portfolioData.totalValue.toLocaleString('en-US', { minimumFractionDigits: 2 })}</p>
          ...
          <div className="summary-card total-gain">
            ...
            <p className={`value ${portfolioData.totalGain >= 0 ? 'positive' : 'negative'}`}>
              ${Math.abs(portfolioData.totalGain).toLocaleString('en-US', { minimumFractionDigits: 2 })}
            </p>
          ...
          <div className="positions-table">
            ...
            {portfolioData.positions.map(position => (
              <div key={position.id} className="table-row">
                ...
                <span>${position.value.toLocaleString('en-US', { minimumFractionDigits: 2 })}</span>
                <div className={`gain-loss ${position.gainLoss >= 0 ? 'positive' : 'negative'}`}>
                  <span>${Math.abs(position.gainLoss).toFixed(2)}</span>
                  <span>({position.gainLossPercent >= 0 ? '+' : ''}{position.gainLossPercent}%)</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <style jsx>{`
          ...
          .positions-section h2, .trades-section h2 {
            margin: 0 0 1.5rem 0;
            color: #2d3748;
            font-size: 1.5rem;
          }
