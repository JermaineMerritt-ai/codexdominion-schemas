...
const SovereignInheritanceParticles: React.FC = () => {
  const particles = Array.from({ length: 120 }, (_, i) => ({
    ...
    color: i % 10 === 0 ? '#ffd700' : i % 10 === 1 ? '#ffffff' : i % 10 === 2 ? '#32cd32' : i % 10 === 3 ? '#ff4500' : i % 10 === 4 ? '#8a2be2' : i % 10 === 5 ? '#00bfff' : i % 10 === 6 ? '#ff69b4' : i % 10 === 7 ? '#ffa500' : i % 10 === 8 ? '#00ff7f' : '#ff1493'
  }));
    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <style jsx>{`
        @keyframes sovereignInheritanceFlow {
          ...
          4% { transform: translate(70px, -180px) scale(2.2) rotate(14deg); opacity: 0.9; }
          15% { transform: translate(-60px, -360px) scale(0.4) rotate(50deg); opacity: 0.85; }
          28% { transform: translate(80px, -540px) scale(1.8) rotate(100deg); opacity: 0.9; }
          42% { transform: translate(-70px, -720px) scale(0.6) rotate(150deg); opacity: 0.8; }
          56% { transform: translate(75px, -900px) scale(1.5) rotate(200deg); opacity: 0.85; }
          70% { transform: translate(-55px, -1080px) scale(0.5) rotate(250deg); opacity: 0.75; }
          84% { transform: translate(65px, -1260px) scale(1.2) rotate(300deg); opacity: 0.8; }
          95% { transform: translate(-35px, -1440px) scale(0.3) rotate(340deg); opacity: 0.4; }
          100% { transform: translate(0, -1600px) scale(0.005) rotate(360deg); opacity: 0.005; }
        }
      `}</style>
    </div>
  );
...
const InheritanceRealms: React.FC = () => {
  ...
  const inheritanceRealms = [
    ...
    { name: "Inheritance", icon: "📜", position: { bottom: '25%', right: '5%' } },
    ...
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-40">
        <div className="text-center text-gold-100 text-4xl leading-relaxed max-w-8xl space-y-6">
          ...
          <p className="opacity-95 text-gold-200 text-4xl">diaspora echoes — inheritance sovereign.</p>
