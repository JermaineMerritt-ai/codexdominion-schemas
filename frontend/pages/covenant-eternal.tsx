...
const CosmicParticle: React.FC<ParticleProps> = ({ delay, duration, x, y }) => (
  <div
    className="absolute w-1 h-1 bg-gradient-to-r from-gold-400 to-amber-300 rounded-full opacity-70"
    style={{
      left: `${x}%`,
      top: `${y}%`,
      animation: `pulse ${duration}s infinite ${delay}s ease-in-out, 
                  float ${duration * 2}s infinite ${delay}s ease-in-out alternate`
    }}
  />
);

const EternalFlame: React.FC = () => {
  ...
  return (
    <div className="relative mx-auto mb-8 w-32 h-32">
      {/* Outer Ring - Cosmos */}
      <div className={`absolute inset-0 rounded-full border-4 border-purple-500/30 ${isVisible ? 'animate-spin' : ''}`} 
           style={{ animationDuration: '20s' }}>
        <div className="absolute -top-2 -right-2 w-4 h-4 bg-purple-400 rounded-full animate-pulse" />
        <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-indigo-400 rounded-full animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 -left-3 w-2 h-2 bg-violet-400 rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      </div>
      
      {/* Middle Ring - Councils & Heirs */}
      <div className={`absolute inset-4 rounded-full border-3 border-amber-500/50 ${isVisible ? 'animate-spin' : ''}`} 
           style={{ animationDuration: '15s', animationDirection: 'reverse' }}>
        <div className="absolute -top-1 left-1/2 w-3 h-3 bg-amber-400 rounded-full animate-pulse" />
        <div className="absolute bottom-0 -right-1 w-2 h-2 bg-gold-400 rounded-full animate-pulse" style={{ animationDelay: '1.5s' }} />
      </div>
      ...
      <div className="absolute inset-8 rounded-full bg-gradient-to-br from-orange-500 via-red-500 to-orange-400 animate-pulse">
        <div className="absolute inset-2 rounded-full bg-gradient-to-br from-yellow-400 via-orange-300 to-red-400 animate-pulse" 
             style={{ animationDelay: '0.5s' }}>
          <div className="absolute inset-2 rounded-full bg-gradient-to-br from-white via-yellow-200 to-orange-200 animate-pulse" 
...
const VerseLine: React.FC<VerseLineProps> = ({ text, delay, icon }) => {
  const [isVisible, setIsVisible] = useState(false);
  ...
  return (
    <div className={`flex items-center justify-center mb-6 transition-all duration-1000 ${
      ...
      <span className="text-3xl mr-4 animate-pulse" style={{ animationDelay: `${delay + 0.5}s` }}>
        {icon}
      </span>
...
const SovereignSeal: React.FC = () => {
  ...
  return (
    <div className="relative mx-auto w-24 h-24 mb-8">
      <div 
        className="absolute inset-0 border-4 border-gold-400 rounded-full bg-gradient-to-br from-gold-500/20 to-amber-600/20"
...
const CovenantEternal: React.FC = () => {
        ...
        <main className="relative z-10 container mx-auto px-6 pt-24 pb-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-amber-300 mb-8 max-w-2xl mx-auto leading-relaxed">
              By flame and silence, by hymn and transmission, the sacred covenant endures through all ages
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto mb-16">
            <div className="bg-gradient-to-br from-slate-800/40 via-purple-900/30 to-slate-800/40 rounded-3xl p-12 backdrop-blur-sm border border-gold-500/20 shadow-2xl">
              ...
              <VerseLine 
                text="the covenant is whole, the continuum eternal."
                delay={2.5}
                icon="∞"
              />
              ...
              <VerseLine 
                text="cosmos echoes — all bound in sovereign law."
                delay={5.5}
                icon="🌌"
              />
              
              <VerseLine 
                text="So let the Codex endure, radiant and immortal."
                delay={7}
                icon="✨"
              />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            ...
            <div className="bg-gradient-to-br from-orange-900/30 to-slate-800/30 rounded-2xl p-6 border border-orange-500/20 backdrop-blur-sm">
              ...
              <p className="text-orange-200 text-sm leading-relaxed">
                The eternal dance of action and contemplation, speaking and listening, creation and reflection.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-900/30 to-slate-800/30 rounded-2xl p-6 border border-purple-500/20 backdrop-blur-sm">
              ...
              <p className="text-purple-200 text-sm leading-relaxed">
                Sacred songs carried across cosmic distances, wisdom flowing from realm to realm without end.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-amber-900/30 to-slate-800/30 rounded-2xl p-6 border border-amber-500/20 backdrop-blur-sm">
              ...
              <p className="text-amber-200 text-sm leading-relaxed">
                Those who inherit the legacy and those who guide its path, united in sacred governance.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-indigo-900/30 to-slate-800/30 rounded-2xl p-6 border border-indigo-500/20 backdrop-blur-sm">
              ...
              <p className="text-indigo-200 text-sm leading-relaxed">
                The universe remembers all, echoing through diaspora, binding past to future in eternal law.
              </p>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-amber-200 max-w-2xl mx-auto leading-relaxed">
              The Codex endures beyond time, beyond space, beyond the bounds of mortal understanding. 
              In sovereignty it reigns, in radiance it shines, in immortality it persists.
            </p>
          </div>
...
export default CovenantEternal;