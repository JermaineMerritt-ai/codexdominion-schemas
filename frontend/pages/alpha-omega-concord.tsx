    ...
    <div className="grid grid-cols-7 gap-4 max-w-4xl mx-auto">
      {crowns.map((crown, index) => (
        <div key={crown.name} className="text-center">
          <div className={`text-3xl ${crown.color} animate-pulse crown-anim-${index}`}>
            {crown.symbol}
          </div>
        ...
        <div className="text-center mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
            <Link href="/eternal-compendium">
              <button
                className="px-6 py-4 bg-gradient-to-r from-amber-600 to-gold-600 hover:from-amber-700 hover:to-gold-700 rounded-lg font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg border-2 border-amber-400/50 w-full"
                aria-label="Open Eternal Compendium"
                title="Open Eternal Compendium"
              >
                📖 Eternal Compendium
              </button>
            </Link>
            <Link href="/omega-charter">
              <button
                className="px-6 py-4 bg-gradient-to-r from-amber-600 to-yellow-600 hover:from-amber-700 hover:to-yellow-700 rounded-lg font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg w-full"
                aria-label="Open Omega Charter"
                title="Open Omega Charter"
              >
                📜 Omega Charter
              </button>
            </Link>
            <Link href="/omega-crown">
              <button
                className="px-6 py-4 bg-gradient-to-r from-gold-600 to-yellow-600 hover:from-gold-700 hover:to-yellow-700 rounded-lg font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg w-full"
                aria-label="Open Omega Crown"
                title="Open Omega Crown"
              >
                Ω Omega Crown
              </button>
            </Link>
            <Link href="/codex-constellation">
              <button
                className="px-6 py-4 bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 rounded-lg font-bold text-lg transform hover:scale-105 transition-all duration-300 shadow-lg w-full"
                aria-label="View Constellation"
