      ...
      <div className="amm-page">
        ...
        <section className="summary-section">
          ...
          <div className="stats-grid">
            ...
            <div className="stat-card">
              <h3>Active Pools</h3>
              <p className="stat-value">{pools.filter((p) => p.state === 'active').length}</p>
            </div>
            <div className="stat-card">
              <h3>Total TVL</h3>
                ...
                <div key={pool.id} className="pool-card">
                  ...
                  <div className="pool-progress">
                    <div className="progress-label">
                      Utilization:{' '}
                      {pool.cap > 0 ? (((pool.tvl || 0) / pool.cap) * 100).toFixed(1) : '0'}%
                    </div>
                  ...
                  <div className="pool-updated">
                    <small>Updated: {new Date(pool.updated_at).toLocaleDateString()}</small>
                  </div>
                </div>
              ))
            ) : (
