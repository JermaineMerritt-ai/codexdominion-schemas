      ...
      {wisdomElements.map((element, index) => (
        ...
        >
          <div
            ...
            style={{
              filter:
                wisdomPhase === index ? 'drop-shadow(0 0 25px rgba(168, 85, 247, 0.9))' : 'none',
            }}
          >
            {element.icon}
          </div>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-900 via-purple-800 to-indigo-900 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-30">
        <div
          className="absolute top-1/4 left-1/3 w-88 h-88 bg-violet-400/25 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '12s' }}
        />
        <div
          className="absolute bottom-1/3 right-1/4 w-72 h-72 bg-purple-400/20 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '16s', animationDelay: '6s' }}
        />
        <div
          className="absolute top-1/2 right-1/3 w-64 h-64 bg-indigo-400/15 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '20s', animationDelay: '10s' }}
        />
        <div
          className="absolute bottom-1/2 left-1/4 w-80 h-80 bg-violet-500/12 rounded-full filter blur-3xl animate-pulse"
