  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-white via-gold-300 to-purple-600 relative overflow-hidden">
      ...
      <div className="fixed top-0 left-0 w-full h-full pointer-events-none opacity-22">
        <div
          className="absolute top-1/28 left-1/28 w-44 h-44 bg-white/50 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '40s' }}
        />
        <div
          className="absolute bottom-1/28 right-1/28 w-52 h-52 bg-gold-400/45 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '48s', animationDelay: '3s' }}
        />
        <div
          className="absolute top-1/2 right-1/20 w-60 h-60 bg-purple-400/40 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '58s', animationDelay: '6s' }}
        />
        <div
          className="absolute bottom-1/10 left-1/20 w-56 h-56 bg-yellow-400/35 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '65s', animationDelay: '9s' }}
        />
        <div
          className="absolute top-2/3 left-1/28 w-40 h-40 bg-green-400/42 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '73s', animationDelay: '12s' }}
        />
        <div
          className="absolute bottom-1/2 right-1/28 w-48 h-48 bg-cyan-400/38 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '82s', animationDelay: '15s' }}
        />
        <div
          className="absolute top-1/4 left-1/10 w-64 h-64 bg-red-400/32 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '90s', animationDelay: '18s' }}
        />
        <div
          className="absolute bottom-3/4 right-1/10 w-36 h-36 bg-blue-400/40 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '98s', animationDelay: '21s' }}
        />
        <div
          className="absolute top-1/10 left-1/4 w-32 h-32 bg-indigo-400/45 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '105s', animationDelay: '24s' }}
        />
        <div
          className="absolute bottom-1/20 right-1/4 w-28 h-28 bg-violet-400/50 rounded-full filter blur-3xl animate-pulse"
          style={{ animationDuration: '113s', animationDelay: '27s' }}
        />
      </div>
    </div>
  );
