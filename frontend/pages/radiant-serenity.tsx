...
const RadiantSereneParticles: React.FC = () => {
  const particles = Array.from({ length: 200 }, (_, i) => ({
    ...
    color: i % 20 === 0 ? '#ffd700' : i % 20 === 1 ? '#ffffff' : i % 20 === 2 ? '#ffff00' : i % 20 === 3 ? '#32cd32' : i % 20 === 4 ? '#00ff7f' : i % 20 === 5 ? '#ff6347' : i % 20 === 6 ? '#ff69b4' : i % 20 === 7 ? '#8a2be2' : i % 20 === 8 ? '#4b0082' : i % 20 === 9 ? '#00ced1' : i % 20 === 10 ? '#ffa500' : i % 20 === 11 ? '#9370db' : i % 20 === 12 ? '#ff1493' : i % 20 === 13 ? '#00bfff' : i % 20 === 14 ? '#daa520' : i % 20 === 15 ? '#7b68ee' : i % 20 === 16 ? '#20b2aa' : i % 20 === 17 ? '#dc143c' : i % 20 === 18 ? '#add8e6' : '#f0f8ff'
  }));
    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <style jsx>{`
        @keyframes radiantSereneFlow {
          ...
          10% { transform: translate(100px, -250px) scale(2.0) rotate(25deg); opacity: 1.0; }
          20% { transform: translate(-90px, -500px) scale(0.3) rotate(70deg); opacity: 0.95; }
          30% { transform: translate(110px, -750px) scale(1.8) rotate(125deg); opacity: 1.0; }
          40% { transform: translate(-100px, -1000px) scale(0.5) rotate(180deg); opacity: 0.9; }
          50% { transform: translate(95px, -1250px) scale(1.6) rotate(235deg); opacity: 0.95; }
          60% { transform: translate(-85px, -1500px) scale(0.4) rotate(290deg); opacity: 0.85; }
          70% { transform: translate(90px, -1750px) scale(1.4) rotate(345deg); opacity: 0.9; }
          80% { transform: translate(-80px, -2000px) scale(0.6) rotate(400deg); opacity: 0.75; }
          90% { transform: translate(70px, -2250px) scale(1.0) rotate(455deg); opacity: 0.8; }
          95% { transform: translate(-60px, -2500px) scale(0.2) rotate(490deg); opacity: 0.4; }
          98% { transform: translate(40px, -2750px) scale(0.4) rotate(520deg); opacity: 0.2; }
          100% { transform: translate(0, -3000px) scale(0.005) rotate(540deg); opacity: 0.005; }
        }
      `}</style>
    </div>
  );
      ...
      {sereneRealms.map((realm, index) => (
        ...
        >
          <div 
            ...
            style={{ 
              filter: sereneRealmPhase === index ? 'drop-shadow(0 0 60px rgba(255, 255, 255, 1.8))' : 'none'
            }}
          >
            {realm.icon}
          </div>
