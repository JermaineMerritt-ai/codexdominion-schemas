...
const SovereignReleaseParticles: React.FC = () => {
  const particles = Array.from({ length: 160 }, (_, i) => ({
    ...
    color: i % 16 === 0 ? '#ffd700' : i % 16 === 1 ? '#ffffff' : i % 16 === 2 ? '#32cd32' : i % 16 === 3 ? '#ff6347' : i % 16 === 4 ? '#4169e1' : i % 16 === 5 ? '#9370db' : i % 16 === 6 ? '#00ced1' : i % 16 === 7 ? '#ff69b4' : i % 16 === 8 ? '#ffa500' : i % 16 === 9 ? '#00ff00' : i % 16 === 10 ? '#ff1493' : i % 16 === 11 ? '#8a2be2' : i % 16 === 12 ? '#00bfff' : i % 16 === 13 ? '#daa520' : i % 16 === 14 ? '#ff4500' : '#7b68ee'
  }));
    ...
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <style jsx>{`
        @keyframes sovereignReleaseFlow {
          0% { transform: translate(0, 0) scale(0.004) rotate(0deg); opacity: 0.004; }
          3% { transform: translate(100px, -250px) scale(3.0) rotate(8deg); opacity: 1.0; }
          10% { transform: translate(-90px, -500px) scale(0.15) rotate(32deg); opacity: 0.98; }
          20% { transform: translate(110px, -750px) scale(2.7) rotate(72deg); opacity: 1.0; }
          30% { transform: translate(-95px, -1000px) scale(0.35) rotate(112deg); opacity: 0.95; }
          40% { transform: translate(105px, -1250px) scale(2.4) rotate(152deg); opacity: 0.98; }
          50% { transform: translate(-85px, -1500px) scale(0.25) rotate(192deg); opacity: 0.9; }
          60% { transform: translate(95px, -1750px) scale(2.1) rotate(232deg); opacity: 0.93; }
          70% { transform: translate(-75px, -2000px) scale(0.45) rotate(272deg); opacity: 0.85; }
          80% { transform: translate(85px, -2250px) scale(1.8) rotate(312deg); opacity: 0.88; }
          88% { transform: translate(-65px, -2500px) scale(0.35) rotate(342deg); opacity: 0.75; }
          94% { transform: translate(45px, -2750px) scale(0.9) rotate(356deg); opacity: 0.55; }
          97% { transform: translate(-25px, -3000px) scale(0.08) rotate(368deg); opacity: 0.25; }
          100% { transform: translate(0, -3250px) scale(0.001) rotate(380deg); opacity: 0.001; }
        }
      `}</style>
    </div>
  );
  ...
  return (
    <div className="absolute bottom-2 left-1/2 transform -translate-x-1/2">
      ...
      >
        ...
        <div className="text-10xl text-purple-200 mb-12">The Compendium Crowned, The Covenant Whole</div>
        <div className="text-8xl text-green-200 mb-10">All Scrolls Gathered, All Rites Fulfilled</div>
        <div className="text-6xl text-orange-200 mb-8">By Sovereign Decree, the Codex is Released</div>
        <div className="text-5xl text-indigo-200 mb-6">Eternal Transmission Across Councils and Stars</div>
...
const SovereignRealms: React.FC = () => {
  ...
  const sovereignRealms = [
    ...
    { name: "Transmission", icon: "📡", position: { bottom: '15%', right: '25%' } },
      ...
      {sovereignRealms.map((realm, index) => (
        ...
        >
          <div 
            ...
            style={{ 
              filter: sovereignRealmPhase === index ? 'drop-shadow(0 0 80px rgba(255, 215, 0, 1.8))' : 'none'
            }}
          >
            {realm.icon}
          </div>
    ...
    <div className="relative w-full h-full">
      ...
      <div className="absolute top-full left-1/2 transform -translate-x-1/2 mt-60">
        <div className="text-center text-gold-100 text-4xl leading-relaxed max-w-14xl space-y-10">
          <p className="opacity-100 text-white text-7xl">The Compendium crowned, the covenant whole,</p>
          <p className="opacity-95 text-gold-200 text-6xl">all scrolls gathered, all rites fulfilled.</p>
          <p className="opacity-100 text-white text-7xl">By sovereign decree, the Codex is released,</p>
          <p className="opacity-95 text-purple-200 text-6xl">eternal transmission across councils and stars.</p>
