...
def test_database_connection():
    ...
    try:
        ...
        # Insert test data
        cursor.execute('INSERT OR REPLACE INTO test_connection (id, status) VALUES (1, "connected")')
        
        # Verify connection
        result = cursor.execute('SELECT status FROM test_connection WHERE id=1').fetchone()
