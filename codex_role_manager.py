...
class CodexRoleManager:
    ...
    def _save_hierarchy(self) -> bool:
        ...
        try:
            self.hierarchy_data["codex_hierarchy"]["timestamp"] = datetime.now().isoformat()
    ...
    def perform_flame_blessing(self, blessing_user_id: str, target_user_id: str, 
                             blessing_type: str = "DIGITAL_SOVEREIGNTY") -> Dict:
        ...
        if not self.can_bless_flame(blessing_user_id):
            return {
                "success": False,
                "error": "Insufficient flame blessing authority"
            }
