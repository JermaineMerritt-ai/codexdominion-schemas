...
def check_domain_status():
    ...
    for domain in domains:
        ...
        print(f"   Expected Backend: {domain['type']} on port {domain['expected_port']}")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"   ⚠️  502 Bad Gateway - Backend not responding on port {domain['expected_port']}")
            elif response.status_code == 503:
                print(f"   ⚠️  503 Service Unavailable - Server overloaded or maintenance")
