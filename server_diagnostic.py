...
print("   python3 -m streamlit run codex_dashboard.py --server.port 8095 --server.address 0.0.0.0")
print()
...
print("   nohup python3 -m streamlit run codex_dashboard.py --server.port 8095 --server.address 0.0.0.0 --server.headless true > /tmp/codex.log 2>&1 &")
print()
