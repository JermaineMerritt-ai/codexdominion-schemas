...
2. **Registry**: Pushes to Google Container Registry  
3. **Deploy**: Launches on Cloud Run with automatic HTTPS
4. **Scale**: Automatically scales to zero when not used
5. **Monitor**: Health checks ensure reliability
