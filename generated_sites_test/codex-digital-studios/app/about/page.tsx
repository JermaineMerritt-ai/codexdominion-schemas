      ...
      <nav style={{padding: '20px', background: 'var(--color-primary)', color: 'white'}}>
        ...
        <section style={{padding: 'var(--section-padding) 0'}}>
          <div style={{maxWidth: 'var(--container-width)', margin: '0 auto', padding: '0 20px'}}>
            <h2 style={{fontSize: '2rem', marginBottom: '1rem'}}>About Codex Digital Studios</h2>
            <p>AI-powered web development and digital solutions. Buy our premium templates and hire our expert team.

We are dedicated to providing exceptional service and building lasting relationships with our clients.</p>
          </div>
        </section>
