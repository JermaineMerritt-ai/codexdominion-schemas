...
def show_domain_overview():
    ...
    with col2:
        ...
        fig2.update_layout(
            polar=dict(radialaxis=dict(visible=True, range=[8, 10])),
    ...
    with col2:
        if st.button("🧬 Generate Biotech Intelligence"):
            with st.spinner("Analyzing biotechnology landscape..."):
                ...
                intelligence = generate_biotech_intelligence(
                    therapeutic_area, analysis_type
                )
...
def show_cross_domain_analysis():
    ...
    with col1:
        ...
        for correlation in correlations:
            priority_color = (
                "red" if correlation["priority"] == "Critical" else "orange"
            )
            st.markdown(
                f"""
...
def show_threat_market_intelligence():
    ...
    with col1:
        ...
        threat_trends = [
            ...
            {
                "threat": "Supply Chain Firmware Attacks",
                "growth": "+180%",
                "impact": "High",
            },
            {
                "threat": "Quantum-Resistant Encryption Bypass",
                "growth": "+95%",
                "impact": "Critical",
            },
            {
                "threat": "IoT Botnet Proliferation",
                "growth": "+165%",
                "impact": "Medium",
            },
            {
                "threat": "Deepfake Disinformation Campaigns",
                "growth": "+320%",
                "impact": "High",
            },
        ]
        ...
        for threat in threat_trends:
            impact_color = {"Critical": "red", "High": "orange", "Medium": "yellow"}[
                threat["impact"]
            ]
            st.markdown(
                f"""
    ...
    with col2:
        ...
        market_trends = [
            ...
            {
                "sector": "CAR-T Cell Therapy",
                "market_size": "$4.1B",
                "growth": "28.5%",
                "outlook": "Bullish",
            },
            {
                "sector": "CRISPR Technology",
                "market_size": "$3.8B",
                "growth": "19.7%",
                "outlook": "Bullish",
            },
        ...
        market_df["Market Value"] = (
            market_df["market_size"]
            .str.replace("$", "")
            .str.replace("B", "")
            .astype(float)
        )
...
def generate_threat_intelligence(threat_type, target_sector):
    ...
    return {
        ...
        "mitre_tactics": [
            {
                "name": "Initial Access",
                "techniques": ["Spearphishing", "Valid Accounts"],
                "prevalence": 0.85,
            },
            {
                "name": "Persistence",
                "techniques": ["Registry Modification", "Scheduled Tasks"],
                "prevalence": 0.72,
            },
            {
                "name": "Defense Evasion",
                "techniques": ["Process Injection", "Obfuscation"],
                "prevalence": 0.68,
            },
        ],
        "iocs": [
...
def generate_biotech_intelligence(therapeutic_area, analysis_type):
    ...
    return {
        ...
        "regulatory_pathways": [
            {
                "name": "Traditional BLA",
                "timeline": "12-18 months",
                "requirements": ["Phase 3 data", "CMC package"],
            },
            {
                "name": "Accelerated Approval",
                "timeline": "6-10 months",
                "requirements": ["Surrogate endpoint", "Unmet need"],
            },
            {
                "name": "Breakthrough Therapy",
                "timeline": "8-12 months",
                "requirements": ["Substantial improvement", "Preliminary evidence"],
            },
        ],
    }
